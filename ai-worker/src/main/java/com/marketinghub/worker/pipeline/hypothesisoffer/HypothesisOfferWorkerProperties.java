...
/** Responsabilidade: concentrar as propriedades operacionais da etapa Oferta do pipeline de hipótese. */
@Validated
@ConfigurationProperties(prefix = "hypothesis-offer.worker")
public record HypothesisOfferWorkerProperties(
        boolean enabled,
    ...
    public HypothesisOfferWorkerProperties {
