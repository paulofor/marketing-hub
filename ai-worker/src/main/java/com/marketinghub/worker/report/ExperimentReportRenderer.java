...
public class ExperimentReportRenderer {
    ...
    private void appendLeadPortalFlows(StringBuilder html, List<LeadPortalFlowSnapshot> flows) {
        ...
        html.append(sectionHeader("Fluxos Lead Portal"));
        wrapCard(html, () -> flows.forEach(flow -> {
            html.append("<div style='margin-bottom:18px;'>")
                    .append("<strong>").append(escape(flow.getName())).append("</strong>")
                    .append("<div class='muted'>Modelo: ")
