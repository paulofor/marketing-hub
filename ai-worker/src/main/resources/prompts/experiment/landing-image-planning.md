...
2. `campaignAngle`, `adCopy`, wireframe e copy aprovados.
...
5. `imagePrompt` deve ser específico para a seção e coerente com o contrato de promessa única, ângulo/copy aprovados.
...
26. Garanta contraste visual entre “antes/dor” e “depois/resultado” de forma ética e sem promessas irreais, mantendo continuidade com copy, oferta e contrato de promessa única aprovados.
27. Se houver conflito entre criatividade visual e `CONTRATO_PROMESSA_UNICA`, preserve o contrato comercial e adapte apenas a forma visual.
