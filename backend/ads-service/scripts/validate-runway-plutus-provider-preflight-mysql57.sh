...
COMPOSE_PROJECT="${RUNWAY_PREFLIGHT_COMPOSE_PROJECT:-liquibase-runway-plutus-preflight}"
...
cleanup
compose build
compose up -d mysql57-runway-plutus-preflight
...
echo "[MYSQL57] Preflight Runway/Plutus validado com identidade, DATETIME, FKs, retomada e reaplicação."
