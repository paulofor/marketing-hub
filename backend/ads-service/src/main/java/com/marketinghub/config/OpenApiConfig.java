...
public class OpenApiConfig {
  ...
  private static final String BACKEND_DESCRIPTION =
      "Documentação dinâmica dos endpoints publicados pelo backend principal do Marketing Hub.";
  ...
  public OpenAPI marketingHubOpenApi() {
    return new OpenAPI()
        ...
        .servers(
            List.of(new Server().url("/").description("Servidor atual do backend Spring Boot")));
  }
