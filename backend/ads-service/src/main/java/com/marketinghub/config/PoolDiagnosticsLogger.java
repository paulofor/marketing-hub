...
public class PoolDiagnosticsLogger {
  ...
  public PoolDiagnosticsLogger(
      ...
      @Value("${diagnostics.hikari.warn-active-threshold-percent:80}")
          int warnActiveConnectionsThresholdPercent) {
  ...
  public void logPoolDiagnostics() {
    ...
    if (awaiting > 0 || active >= threshold) {
      LOGGER.warn(
          "Diagnóstico do pool detectou pressão. pool={}, active={}, idle={}, total={}, max={},"
              + " awaiting={}, cpuLoad={}, availableProcessors={}, usedMemoryMb={}, maxMemoryMb={}",
    ...
    LOGGER.info(
        "Diagnóstico periódico do pool. pool={}, active={}, idle={}, total={}, max={}, awaiting={},"
            + " cpuLoad={}, usedMemoryMb={}, maxMemoryMb={}",
        hikariDataSource.getPoolName(),
        active,
        idle,
        total,
