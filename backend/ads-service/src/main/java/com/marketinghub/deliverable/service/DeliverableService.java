...
public class DeliverableService {
  ...
  public DeliverableService(
      DeliverableRepository repository, MarketNicheRepository nicheRepository) {
  ...
  public Deliverable get(Long id) {
    return repository
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(HttpStatus.NOT_FOUND, "Deliverable not found: " + id));
  }
  ...
  public Deliverable create(CreateDeliverableRequest request) {
    ...
    MarketNiche niche =
        nicheRepository
            .findById(request.getMarketNicheId())
            .orElseThrow(
                () ->
