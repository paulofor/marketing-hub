...
/**
 * Expõe os endpoints operacionais do módulo EPM para planejamento, métricas, decisões e simulação
 * financeira.
 */
@RestController
...
public class EpmController {
  ...
  public FinancialPlanResponse createFinancialPlan(
      @Valid @RequestBody CreateFinancialPlanRequest request) {
  ...
  public FinancialPlanResponse updateFinancialPlan(
      @PathVariable Long planId, @Valid @RequestBody UpdateFinancialPlanRequest request) {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public FinancialPlanNicheResponse createPlanNiche(
      @PathVariable Long planId, @Valid @RequestBody CreatePlanNicheRequest request) {
  ...
  public FinancialPlanHypothesisResponse createPlanHypothesis(
      @PathVariable Long planNicheId, @Valid @RequestBody CreatePlanHypothesisRequest request) {
  ...
  public ExperimentBudgetResponse createExperimentBudget(
      @PathVariable Long planHypothesisId,
      @Valid @RequestBody CreateExperimentBudgetRequest request) {
  ...
  public ExperimentBudgetResponse updateExperimentBudget(
      @PathVariable Long experimentBudgetId,
      @Valid @RequestBody UpdateExperimentBudgetRequest request) {
  ...
  public ExperimentMetricResponse createExperimentMetric(
      @PathVariable Long experimentBudgetId,
      @Valid @RequestBody CreateExperimentMetricRequest request) {
  ...
  public ExperimentDecisionResponse createExperimentDecision(
      @PathVariable Long experimentBudgetId,
      @Valid @RequestBody CreateExperimentDecisionRequest request) {
  ...
  public ExperimentDecisionListResponse listExperimentDecisions(
      @PathVariable Long experimentBudgetId) {
  ...
  public ProductPriceScenarioResponse createProductPriceScenario(
      @PathVariable Long planId, @Valid @RequestBody CreateProductPriceScenarioRequest request) {
