...
public record ExperimentMetricResponse(
    ...
    Integer visitors,
    Integer leads,
    Integer sampleRequests,
    Integer checkoutClicks,
    Integer purchases,
    Long adSpendCents,
    Long revenueCents,
    Long paymentFeeCents,
    Long platformFeeCents,
    Long aiCostCents,
    Long taxEstimateCents,
    Long grossProfitCents,
    Long estimatedNetProfitCents,
    BigDecimal ctrDecimal,
    Long cpcCents,
    Long cplCents,
    Long cpaCents,
    BigDecimal roasDecimal,
    BigDecimal landingConversionDecimal,
    BigDecimal purchaseConversionDecimal,
    String notes,
    Instant createdAt) {}
