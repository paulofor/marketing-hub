...
public class FrameworkImageGenerationJobInternalController {
  ...
  @GetMapping("/pending")
  public List<FrameworkImageGenerationJobDto> listPending(
      @RequestParam(value = "limit", defaultValue = "10") Integer limit) {
    return service.listPendingJobs(limit != null ? limit : 10);
  }

  @PostMapping("/{jobId}/claim")
  public FrameworkImageGenerationJobDto claim(
  ...
  public void complete(
      @PathVariable UUID jobId, @RequestBody FrameworkImageGenerationJobCompletionRequest request) {
