...
/**
 * Solicitação assíncrona para gerar automaticamente o resumo e os aprendizados do experimento.
 */
@Entity
@Table(name = "experiment_learning_request")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ExperimentLearningRequest {
    @Id
