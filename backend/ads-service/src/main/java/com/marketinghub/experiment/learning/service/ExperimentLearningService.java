...
public class ExperimentLearningService {
  ...
  public ExperimentLearningService(
      ExperimentLearningRepository repository,
  ...
  @Transactional
  public ExperimentLearning registerResult(
      ExperimentLearningRequest request, ExperimentLearningPayloadDto payload) {
    ...
    ExperimentLearning learning =
        ExperimentLearning.builder()
            ...
            .suggestionsJson(
                codec.writeSuggestions(payload != null ? payload.getSuggestions() : null))
            .openAiRequestPayloadJson(
                codec.writeObject(payload != null ? payload.getOpenAiRequestPayload() : null))
            .completedAt(Instant.now())
            .build();
    return repository.save(learning);
  }

  private ExperimentStage resolveStage(
      Experiment experiment, ExperimentLearningPayloadDto payload) {
