...
public interface ExperimentMapper {
  ...
  @org.mapstruct.Mapping(
      target = "imageModelQualityName",
      source = "imageGenerationQuality.displayName")
  @org.mapstruct.Mapping(target = "selectedSampleEmailId", source = "selectedSampleEmail.id")
  @org.mapstruct.Mapping(
      target = "selectedSampleEmailSubject",
      source = "selectedSampleEmail.subject")
  @org.mapstruct.Mapping(
      target = "selectedSampleEmailPreviewText",
      source = "selectedSampleEmail.previewText")
  @org.mapstruct.Mapping(
      target = "selectedSampleEmailCallToAction",
      source = "selectedSampleEmail.callToAction")
  @org.mapstruct.Mapping(target = "selectedSampleEmailModel", source = "selectedSampleEmail.model")
  @org.mapstruct.Mapping(
      target = "selectedSampleEmailUpdatedAt",
      source = "selectedSampleEmail.updatedAt")
  ...
  @org.mapstruct.Mapping(
      ...
      expression = "java(toCampaignMetricDto(experiment.getCampaignMetric()))")
  ...
  default void fillCostReconciliation(Experiment experiment, @MappingTarget ExperimentDto dto) {
    ...
    BigDecimal unreconciled =
        legacyTotal.subtract(auditableTotal).setScale(2, RoundingMode.HALF_UP);
