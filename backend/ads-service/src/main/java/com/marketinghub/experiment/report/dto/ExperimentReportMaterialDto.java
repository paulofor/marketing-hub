...
public class ExperimentReportMaterialDto {
  ...
  @Builder.Default private List<CreativeSnapshot> creatives = Collections.emptyList();
  @Builder.Default private List<CreativeVariantSnapshot> creativeVariants = Collections.emptyList();
  @Builder.Default private List<LandingPageSnapshot> landingPages = Collections.emptyList();
  @Builder.Default private List<LeadPortalFlowSnapshot> leadPortalFlows = Collections.emptyList();
  ...
  @Builder.Default private List<ExperimentFunnelStageDto> funnelStages = Collections.emptyList();
