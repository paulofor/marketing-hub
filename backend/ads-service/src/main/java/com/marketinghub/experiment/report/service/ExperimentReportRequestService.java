...
public class ExperimentReportRequestService {
  ...
  private static final Set<ExperimentReportStatus> ACTIVE_STATUSES =
      EnumSet.of(ExperimentReportStatus.PENDING, ExperimentReportStatus.PROCESSING);
  ...
  public ExperimentReportRequestService(
      ExperimentReportRequestRepository repository,
  ...
  public ExperimentReportRequest create(Long experimentId, String requestedBy) {
    ...
    if (repository.existsByExperimentIdAndStatusIn(experimentId, ACTIVE_STATUSES)) {
      throw new IllegalStateException(
          "Já existe uma solicitação de relatório em andamento para este experimento.");
    }
    ExperimentReportRequest request =
        ExperimentReportRequest.builder()
            .experiment(experiment)
  ...
  private void applyReady(ExperimentReportRequest request, String downloadUrl) {
    ...
    if (sanitizedUrl == null) {
      throw new IllegalArgumentException(
          "O link de download é obrigatório quando o relatório está pronto.");
    }
  ...
  private void applyFailed(
      ExperimentReportRequest request, String downloadUrl, String failureReason) {
  ...
  private String serializePayload(Long experimentId) {
    try {
      ...
      throw new IllegalStateException(
          "Não foi possível salvar o snapshot de dados do relatório", ex);
    }
  }
}
