...
public class ExperimentReportRequestController {
  ...
  public ExperimentReportRequestController(
  ...
  public List<ExperimentReportRequestDto> list(@PathVariable Long experimentId) {
    return service.listLatestByExperiment(experimentId).stream().map(mapper::toDto).toList();
  }

  @PostMapping
  public ExperimentReportRequestDto create(
