...
public class ExperimentReportRequestProcessingController {
  ...
  public ExperimentReportRequestProcessingController(
      ExperimentReportRequestService service, ExperimentReportRequestMapper mapper) {
    this.service = service;
    this.mapper = mapper;
  }

  @GetMapping
  public List<ExperimentReportRequestDetailDto> list(
      @RequestParam(name = "status", required = false) List<ExperimentReportStatus> statuses) {
  ...
  @PatchMapping("/{id}")
  public ExperimentReportRequestDetailDto update(
      @PathVariable Long id, @Valid @RequestBody UpdateExperimentReportRequest request) {
