...
public class ExperimentFunnelController {
  ...
  public ExperimentLandingAnalyticsVisitorsDto landingAnalyticsVisitors(
  ...
  public void registerEvent(
      @PathVariable Long experimentId, @RequestBody RegisterExperimentFunnelEventRequest request) {
