...
public class ExperimentAdSetWorkflowController {
  ...
  public ExperimentAdSetWorkflowDto startWorkflow(
      @PathVariable Long experimentId,
      @Validated @RequestBody(required = false) StartExperimentAdSetWorkflowRequest request) {
    StartExperimentAdSetWorkflowRequest payload =
        request != null ? request : new StartExperimentAdSetWorkflowRequest(false);
    return workflowService.start(experimentId, payload);
  }

  @GetMapping("/jobs/{jobId}")
  public ExperimentAdSetJobDetailDto getJobDetail(
      @PathVariable Long experimentId, @PathVariable Long jobId) {
