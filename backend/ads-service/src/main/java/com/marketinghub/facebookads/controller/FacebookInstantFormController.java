...
public class FacebookInstantFormController {
  ...
  public FacebookInstantFormController(
      FacebookInstantFormRepository repository,
  ...
  @Transactional
  public FacebookInstantFormDto create(
      @PathVariable UUID hypothesisId, @RequestBody CreateFacebookInstantFormRequest request) {
    var hypothesis =
    ...
    var page =
        pageRepository
            .findById(request.facebookPageId())
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "facebookPageId not found"));
  ...
  public FacebookInstantFormDto get(@PathVariable Long id) {
    return repository
        ...
        .map(this::applyDefaults)
        .orElseThrow(
            () -> new ResponseStatusException(HttpStatus.NOT_FOUND, "instant form not found"));
  }

  @PatchMapping("/instant-forms/{id}/approval")
  @Transactional
  public FacebookInstantFormDto updateApproval(
      @PathVariable Long id, @RequestBody UpdateFacebookInstantFormApprovalRequest request) {
  ...
  @Transactional
  public FacebookInstantFormDto updatePublication(
      @PathVariable Long id, @RequestBody UpdateFacebookInstantFormPublicationRequest request) {
    FacebookInstantForm form =
        repository
            .findById(id)
            .orElseThrow(
    ...
    if (request.published()) {
      ...
      form.setShareLink(
          request.shareLink() != null && !request.shareLink().isBlank()
              ? request.shareLink()
              : null);
  ...
  private String resolveFollowUpActionUrl(FacebookInstantFormDto dto) {
    ...
    return experimentRepository
        .findFirstByFacebookInstantForm_Id(dto.id())
