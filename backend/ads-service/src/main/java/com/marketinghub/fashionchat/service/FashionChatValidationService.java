...
public class FashionChatValidationService {
  ...
  @Autowired
  public FashionChatValidationService(
  ...
  FashionChatValidationService(
      RestTemplate restTemplate, ObjectMapper objectMapper, String serviceBaseUrl) {
  ...
  private ProbeResult getJson(String path) {
    ...
    try {
      ...
      return new ProbeResult(
          ex.getRawStatusCode(),
          false,
          parseJson(ex.getResponseBodyAsString()),
  ...
  private record ProbeResult(
      Integer httpStatus, boolean success, JsonNode body, String errorMessage) {}
}
