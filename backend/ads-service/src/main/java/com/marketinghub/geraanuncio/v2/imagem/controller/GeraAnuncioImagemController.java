package com.marketinghub.geraanuncio.v2.imagem.controller;

import com.marketinghub.geraanuncio.v2.imagem.service.GeraAnuncioImagemService;
...
@RestController
@RequestMapping("/api/internal/geraanuncio/v2/imagem/stage-executions")
