package com.marketinghub.geraanuncio.v2.texto.controller;

import com.marketinghub.geraanuncio.v2.texto.service.GeraAnuncioTextoService;
...
@RestController
@RequestMapping("/api/internal/geraanuncio/v2/texto/stage-executions")
