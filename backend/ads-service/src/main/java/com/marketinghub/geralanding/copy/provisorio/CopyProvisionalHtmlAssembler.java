...
@Component
/**
 * Conjunto exclusivo da etapa LANDING_PAGE_COPY: coordena o payload resolver e o processor da etapa
 * de copy para gerar HTML provisório sem invadir responsabilidades das demais etapas.
 */
public class CopyProvisionalHtmlAssembler {
  ...
  public CopyProvisionalHtmlAssembler(
      CopyProvisionalHtmlPayloadResolver payloadResolver,
