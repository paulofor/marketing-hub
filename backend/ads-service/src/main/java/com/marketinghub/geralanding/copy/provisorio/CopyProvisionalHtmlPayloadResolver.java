...
public class CopyProvisionalHtmlPayloadResolver {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(CopyProvisionalHtmlPayloadResolver.class);
  ...
  public CopyProvisionalHtmlPayload resolve(String copyModelResponse, String wireframeModelResponse)
      throws Exception {
    log.info(
    ...
    Map<String, Object> wireframe =
        wireframeRoot.get("landingPageWireframe") instanceof Map<?, ?> nested
            ? (Map<String, Object>) nested
            : wireframeRoot;

    Map<String, Object> copyRoot = objectMapper.readValue(copyModelResponse, Map.class);
    Map<String, Object> copy =
        copyRoot.get("landingPageCopy") instanceof Map<?, ?> nested
            ? (Map<String, Object>) nested
            : copyRoot;
  ...
  public record CopyProvisionalHtmlPayload(
      Map<String, Object> wireframe, Map<String, Object> copy) {}
}
