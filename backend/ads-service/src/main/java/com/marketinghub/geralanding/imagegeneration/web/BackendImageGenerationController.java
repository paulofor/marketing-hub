...
/**
 * Responsável por expor os endpoints de backend da etapa landing-page-image-generation no
 * GeraLanding.
 */
@RestController
@RequestMapping("/api")
public class BackendImageGenerationController {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(BackendImageGenerationController.class);
  ...
  public ResponseEntity<GeraLandingImageGenerationStartResponse> start(
  ...
  public ResponseEntity<List<GeraLandingImageGenerationExecutionSummaryResponse>>
      listStageExecutions(
          @PathVariable Long experimentId,
