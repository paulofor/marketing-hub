...
public class BackendPresetDesignController {
  ...
  /** Inicializa o controller com o serviço backend da etapa preset design. */
  ...
  /** Lista os jobs pendentes iniciados da etapa preset design para processamento pelo Worker AI. */
  ...
  /** Recebe a resposta da IA para a etapa preset design e conclui a execução do job. */
