...
public class BackendPublicLandingController {
  ...
  /**
   * Aprova e publica a landing final no Lead Portal, mantendo alias legado com `and` para
   * compatibilidade.
   */
  @PostMapping({
  ...
  /**
   * Responde à rota canônica interna informando que não há pendências assíncronas para landing
   * pública.
   */
  ...
  public ResponseEntity<Void> recebePrompt(
      @PathVariable String idJob, @RequestBody(required = false) Object payload) {
  ...
  public ResponseEntity<Object> detailStageExecution(
