...
public class BackendQualityReviewController {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(BackendQualityReviewController.class);
  ...
  public ResponseEntity<GeraLandingQualityReviewStartResponse> start(
  ...
  public ResponseEntity<List<GeraLandingQualityReviewExecutionSummaryResponse>> listStageExecutions(
    ...
    return ResponseEntity.ok(
        executionService.listExperimentStageExecutions(experimentId, includeCompleted));
  }
  ...
  /**
   * Recebe prompt, schema e request visual enviados para IA e marca a execução aguardando retorno
   * da OpenAI.
   */
