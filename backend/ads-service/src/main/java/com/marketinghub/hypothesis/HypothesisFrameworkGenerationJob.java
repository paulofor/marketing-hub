...
public class HypothesisFrameworkGenerationJob {
  ...
  @Column(nullable = false, length = 32)
  @Builder.Default
  private HypothesisFrameworkGenerationJobStatus status =
      HypothesisFrameworkGenerationJobStatus.PENDING;

  @Enumerated(EnumType.STRING)
  @Column(name = "stage", nullable = false, length = 32)
  @Builder.Default
  private HypothesisFrameworkGenerationJobStage stage =
      HypothesisFrameworkGenerationJobStage.WAITING_AI_WORKER;
