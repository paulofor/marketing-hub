...
/**
 * Responsabilidade: isolar a leitura provisória do perfil enriquecido usado como contexto da
 * hipótese de dor.
 */
@Component
public class HypothesisPainEnrichmentProfileReader {
  ...
  public HypothesisPainEnrichmentProfileReader(
  ...
  public Optional<HypothesisPainEnrichmentProfileSnapshot> findLatestByMarketNicheId(
      Long marketNicheId) {
