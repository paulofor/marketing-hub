...
public class HypothesisFrameworkGenerationJobInternalController {
  ...
  public HypothesisFrameworkGenerationJobInternalController(
      HypothesisFrameworkGenerationService service) {
    this.service = service;
  }

  @GetMapping("/pending")
  public List<HypothesisFrameworkGenerationJobDto> listPending(
      @RequestParam(value = "limit", defaultValue = "10") Integer limit) {
    return service.listPendingJobs(limit != null ? limit : 10);
  }

  @PostMapping("/{jobId}/claim")
  public HypothesisFrameworkGenerationJobDto claim(
