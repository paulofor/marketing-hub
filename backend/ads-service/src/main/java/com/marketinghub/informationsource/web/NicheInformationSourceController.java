...
public class NicheInformationSourceController {
  ...
  public NicheInformationSourceController(
      InformationSourceService service, InformationSourceMapper mapper) {
  ...
  @PostMapping
  public InformationSourceDto create(
      @PathVariable Long nicheId, @RequestBody CreateInformationSourceRequest request) {
