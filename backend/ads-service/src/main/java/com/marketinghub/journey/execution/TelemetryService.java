...
public class TelemetryService {
  ...
  public void emitStepDispatched(
  ...
  private void sendGa4Event(
    ...
    String url =
        ga4Properties.getEndpoint()
            + "?measurement_id="
            + ga4Properties.getMeasurementId()
            + "&api_secret="
            + ga4Properties.getApiSecret();
    HttpHeaders headers = new HttpHeaders();
    headers.setContentType(MediaType.APPLICATION_JSON);
