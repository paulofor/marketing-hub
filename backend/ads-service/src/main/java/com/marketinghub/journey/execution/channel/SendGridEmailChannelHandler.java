...
public class SendGridEmailChannelHandler implements JourneyChannelHandler {
  ...
  @Autowired
  public SendGridEmailChannelHandler(
      RestTemplateBuilder restTemplateBuilder, SendGridProperties properties) {
  ...
  public ChannelDispatchResult dispatch(
    ...
    if (properties.getApiKey() == null || properties.getFromEmail() == null) {
      return ChannelDispatchResult.permanentFailure(
          "SendGrid API key or sender email missing", Map.of());
    }
    ...
    try {
      ...
      if (response.getStatusCode().is5xxServerError()
        ...
        return ChannelDispatchResult.transientFailure(
            "SendGrid transient response: " + response.getStatusCode(), retryAt, Map.of());
      }
      return ChannelDispatchResult.permanentFailure(
          "SendGrid returned status " + response.getStatusCode(), Map.of());
  ...
  private Map<String, Object> buildPayload(
      JourneyStep step, Map<String, Object> context, String toEmail) {
      ...
      payload.put(
          ...
          List.of(
              Map.of(
                  ...
                  "text/plain",
                  "value",
                  Objects.toString(step.getMetadata().get("content")))));
    }
    return payload;
  }
