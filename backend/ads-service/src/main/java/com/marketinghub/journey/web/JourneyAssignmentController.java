...
public class JourneyAssignmentController {
  ...
  public JourneyAssignmentController(
      JourneyAssignmentService assignmentService, JourneyMapper mapper) {
    this.assignmentService = assignmentService;
    this.mapper = mapper;
  }

  @GetMapping("/journeys/{journeyId}/assignments")
  public Page<JourneyAssignmentResponse> list(
  ...
  public List<JourneyAssignmentResponse> assign(
      @PathVariable Long journeyId, @Valid @RequestBody JourneyAssignmentRequest request) {
