...
public class JourneyTemplateController {
  ...
  public JourneyTemplateController(
      JourneyTemplateService templateService,
  ...
  @PatchMapping("/{id}")
  public JourneyTemplateResponse update(
      @PathVariable Long id, @Valid @RequestBody JourneyTemplateUpdateRequest request) {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public JourneyStepResponse createStep(
      @PathVariable Long id, @Valid @RequestBody JourneyStepRequest request) {
