...
public record LeadPortalImagePackageDetailDto(
  ...
  public record SubmissionInfo(
      String flowSlug, String name, String email, String phone, String imageQuestionKey) {}
  ...
  public record ZipExport(String objectKey, String downloadUrl, Instant generatedAt) {}

  public record WatermarkReference(
      Long assetId, String url, String downloadUrl, Instant createdAt, String storedFileName) {}
}
