...
/**
 * Representa o payload enviado ao serviço de e-mail com dados do pacote e conteúdo do e-mail de
 * amostra.
 */
public record LeadPortalImagePackageExportDto(
  ...
  public record EmailContent(String subject, String plainBody, String htmlBody) {}
