...
/**
 * Resolves the best hero image URL available for a given experiment, priorizando os assets
 * produzidos pelo framework-image pipeline.
 */
@Component
public class ExperimentHeroImageResolver {
  ...
  public ExperimentHeroImageResolver(
      FrameworkImageGenerationJobRepository jobRepository, ObjectMapper objectMapper) {
  ...
  public Optional<String> resolve(Experiment experiment) {
    ...
    List<FrameworkImageGenerationJob> jobs =
        jobRepository.findByExperimentIdAndPlanningItemKeyInAndStatusOrderByCreatedAtDesc(
