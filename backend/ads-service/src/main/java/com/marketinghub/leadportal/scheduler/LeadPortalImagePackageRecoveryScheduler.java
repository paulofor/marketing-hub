...
/**
 * Monitora pacotes que ficaram presos em PROCESSING e reabre ou falha automaticamente para evitar
 * que o pipeline fique parado indefinidamente.
 */
@Component
public class LeadPortalImagePackageRecoveryScheduler {

  private static final Logger log =
      LoggerFactory.getLogger(LeadPortalImagePackageRecoveryScheduler.class);
