...
public class LeadPortalEmailTemplateService {
  ...
  public Optional<LeadPortalEmailTemplate> findTemplate() {
    Optional<GeneralSettingDto> htmlSetting =
        generalSettingService.findByName(GeneralSettingKeys.LEAD_PORTAL_EMAIL_TEMPLATE_HTML);
    Optional<GeneralSettingDto> subjectSetting =
        generalSettingService.findByName(GeneralSettingKeys.LEAD_PORTAL_EMAIL_TEMPLATE_SUBJECT);
  ...
  public LeadPortalEmailTemplate saveTemplate(String subject, String html) {
    ...
    GeneralSettingDto savedSubject =
        generalSettingService.upsert(
            GeneralSettingKeys.LEAD_PORTAL_EMAIL_TEMPLATE_SUBJECT, sanitizedSubject);
    GeneralSettingDto savedHtml =
        generalSettingService.upsert(
            GeneralSettingKeys.LEAD_PORTAL_EMAIL_TEMPLATE_HTML, sanitizedHtml);
  ...
  private LeadPortalEmailTemplate toTemplate(
      GeneralSettingDto subjectDto, GeneralSettingDto htmlDto) {
    Instant updatedAt =
        Stream.of(subjectDto, htmlDto)
