...
public class LeadPortalFlowEngagementController {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(LeadPortalFlowEngagementController.class);
  ...
  public LeadPortalFlowEngagementController(
      ExperimentFunnelService experimentFunnelService, ObjectMapper objectMapper) {
  ...
  public void registerRenderComplete(
    ...
    log.info(
        "Lead Portal render-complete recebido no backend. slug={}, visitorIdPresent={}, campaignCodePresent={}",
        slug,
        visitorId != null && !visitorId.isBlank(),
  ...
  public ResponseEntity<LeadPortalEngagementAckResponse> registerSubmission(
      @PathVariable String slug,
    ...
    log.info(
        "Lead Portal submission recebido no backend. slug={}, submissionId={}, contractVersion={}",
        slug,
    ...
    if (!accepted) {
      return ResponseEntity.ok(
          new LeadPortalEngagementAckResponse(
  ...
  public record LeadPortalEngagementAckResponse(
      String contractVersion, String slug, String submissionId, String status, String message) {}
  ...
  public ResponseEntity<LeadPortalEngagementAckResponse> registerPageAnalytics(
      @PathVariable String slug, @RequestBody(required = false) String requestBody) {
    log.info(
        "Lead Portal page-analytics raw recebido no backend. slug={}, rawPayload={}",
        slug,
        requestBody);
    RegisterLandingPageAnalyticsEventRequest request = parsePageAnalyticsRequest(slug, requestBody);
    log.info(
        "Lead Portal page-analytics parseado no backend. slug={}, eventId={}, visitorId={}, eventType={}, sectionId={}, sessionId={}, pageUrl={}, deviceType={}",
        slug,
        request.eventId(),
        request.visitorId(),
        request.eventType(),
  ...
  /**
   * Converte o corpo cru de analytics para o contrato do backend preservando logs em caso de
   * payload inválido.
   */
  private RegisterLandingPageAnalyticsEventRequest parsePageAnalyticsRequest(
      String slug, String requestBody) {
    ...
    try {
      ...
      log.warn(
          "Payload inválido em Lead Portal page-analytics. slug={}, rawPayload={}",
          slug,
          requestBody,
          ex);
