...
public class MdsRequestService {
  ...
  public List<MdsRequestStatusResponse> pendingRequests() {
    return requestRepository.findTop50ByStatusOrderByCreatedAtAsc(MdsRequestStatus.PENDING).stream()
        .map(this::toResponse)
        .toList();
  }
  ...
  public MdsRequestStatusResponse claim(Long id, MdsClaimRequest claimRequest) {
    ...
    persistEvent(
        ...
        "orchestration",
        MdsEventType.INFO,
        "request claimed by worker " + claimRequest.workerId(),
        claimRequest);
  ...
  public MdsRequestStatusResponse complete(Long id, MdsCompleteRequest completeRequest) {
    ...
    persistEvent(
        ...
        "orchestration",
        MdsEventType.INFO,
        defaultValue(completeRequest.message(), "request completed"),
        completeRequest);
    return toResponse(request);
  }
