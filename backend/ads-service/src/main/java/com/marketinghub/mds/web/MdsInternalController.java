...
public class MdsInternalController {
  ...
  public MdsInternalController(
      MdsRequestService requestService,
  ...
  public MdsRequestStatusResponse createRequest(
      @Valid @RequestBody MdsRequestCreateRequest request) {
  ...
  public MdsRequestStatusResponse claim(
      @PathVariable Long id, @Valid @RequestBody MdsClaimRequest request) {
    return requestService.claim(id, request);
  }

  @PostMapping("/requests/{id}/heartbeat")
  public MdsRequestStatusResponse heartbeat(
      @PathVariable Long id, @RequestBody MdsHeartbeatRequest request) {
    return requestService.heartbeat(id, request);
  }

  @PostMapping("/requests/{id}/complete")
  public MdsRequestStatusResponse complete(
      @PathVariable Long id, @RequestBody MdsCompleteRequest request) {
    return requestService.complete(id, request);
  }

  @PostMapping("/requests/{id}/fail")
  public MdsRequestStatusResponse fail(
      @PathVariable Long id, @Valid @RequestBody MdsFailRequest request) {
  ...
  public MdsArtifactPublishBatchResponse publishBatch(
      @Valid @RequestBody MdsArtifactPublishBatchRequest request) {
  ...
  public MdsLineageResponse createLineage(
      @PathVariable Long id, @Valid @RequestBody MdsLineageCreateRequest request) {
