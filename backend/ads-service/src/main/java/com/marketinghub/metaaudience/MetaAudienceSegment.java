...
public class MetaAudienceSegment {
  ...
  @JoinColumn(name = "meta_audience_id")
  ...
  @Lob
  @Column(name = "pain_focus")
  private String painFocus;

  @Lob
  @Column(name = "desired_outcome_focus")
  private String desiredOutcomeFocus;

  @Lob
  @Column(name = "offer_angle")
  private String offerAngle;

  @Lob
  @Column(name = "selection_rule")
  private String selectionRule;

  @Column(name = "estimated_contacts", nullable = false)
  private long estimatedContacts;
