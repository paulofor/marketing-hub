...
public class MetaAudienceController {
  ...
  public ExperimentMetaAudienceResponse linkExperiment(
      @RequestBody LinkMetaAudienceExperimentRequest request) {
  ...
  public List<ExperimentMetaAudienceResponse> listExperimentLinksByNiche(
  ...
  public MetaAudienceResponse complete(
      @PathVariable Long id, @RequestBody MetaAudienceSyncCompleteRequest request) {
