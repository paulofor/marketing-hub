...
public final class MoisSalesLibraryDtos {
  ...
  public record SalesLibraryClaimRequest(@NotBlank String workspaceId, @NotBlank String source) {}

  public record SalesLibraryClaimedJob(
      long jobId, long pageId, String urlCanonical, String title, String rawHtml) {}

  public record SalesLibraryClaimResponse(boolean claimed, SalesLibraryClaimedJob job) {}
  ...
  public record SalesLibraryFailRequest(String errorCategory, String errorMessage) {}
  ...
  public record CollectedReferenceHtmlClaimRequest(
      @NotBlank String workspaceId, @NotBlank String source) {}
  ...
  public record CollectedReferenceHtmlClaimResponse(
      boolean claimed, CollectedReferenceHtmlCaptureJob job) {}
  ...
  public record SalesLibraryUrlItem(@NotBlank String url, String title, Instant capturedAt) {}

  public record SalesLibraryIngestResponse(
      String workspaceId, String source, int received, int persisted) {}

  public record SalesLibraryHotmartCollectedIngestRequest(
      @NotBlank String workspaceId, String jobId, Integer limit) {}
  ...
  public record SalesLibraryJobPageResponse(
      int page, int pageSize, long total, List<SalesLibraryJobResponse> items) {}
  ...
  public record SalesLibraryEntryPageResponse(
      int page, int pageSize, long total, List<SalesLibraryEntryResponse> items) {}
  ...
  public record HotProductDossierEnqueueRequest(
      @NotBlank String workspaceId, BigDecimal minTemperature, Integer limit) {}
  ...
  public record CollectedReferenceUrlTypeBreakdown(String urlType, long uniqueUrls) {}
  ...
  public record SalesLibraryPageListResponse(
      int page, int pageSize, long total, List<SalesLibraryPageResponse> items) {}
  ...
  public record SalesLibraryReanalyzeResponse(
      long pageId, long jobId, String status, Instant createdAt) {}

  public record SalesLibraryStatusUpdateRequest(@NotBlank String status, String reason) {}

  public record SalesLibraryStatusUpdateResponse(
      long pageId, Long jobId, String status, String reason, Instant createdAt) {}

  public record SalesLibrarySnapshotCaptureRequest(
      @NotBlank String workspaceId, Integer limit, Boolean force) {}
  ...
  public record HtmlCaptureJobResponse(
      long snapshotId, long pageId, String urlCanonical, String title) {}

  public record HtmlCaptureClaimResponse(boolean claimed, HtmlCaptureJobResponse job) {}
  ...
  public record MarketWarmupOpportunityRankingResponse(
      String workspaceId, int limit, List<MarketWarmupOpportunityRankingItem> items) {}
  ...
  public record MarketWarmupRequestResponse(
      long pageId, long jobId, MarketWarmupJobStatus status, Instant createdAt) {}
  ...
  public record MarketWarmupSearchAttemptListResponse(
      long pageId, long jobId, List<MarketWarmupSearchAttemptResponse> items) {}
  ...
  public record MarketWarmupSourceListResponse(
      long pageId, long jobId, List<MarketWarmupSourceResponse> items) {}
  ...
  public record MarketWarmupSignalListResponse(
      long pageId, long jobId, List<MarketWarmupSignalResponse> items) {}

  /** Representa o pedido interno do worker para reservar uma pesquisa pendente. */
  public record MarketWarmupClaimRequest(@NotBlank String workspaceId, @NotBlank String workerId) {}
  ...
  /**
   * Representa a solicitação operacional para reprocessar jobs de aquecimento presos em execução
   * antiga.
   */
  public record MarketWarmupReprocessStaleRequest(
      @NotBlank String workspaceId, @Positive Integer staleMinutes) {}

  /**
   * Representa o resultado da ação de saneamento que refileira jobs presos sem acesso direto ao
   * banco.
   */
  public record MarketWarmupReprocessStaleResponse(
      String workspaceId, int staleMinutes, long requeuedJobs, Instant updatedAt) {}
  ...
  public record MarketWarmupCompleteRequest(
    ...
    public MarketWarmupCompleteRequest(
        List<MarketWarmupSearchAttemptCompleteItem> searchAttempts,
  ...
  public record MarketWarmupSearchTermCompleteItem(
      @NotBlank String termText, String reason, String source) {}
