...
public final class MoisInsightDtos {
  ...
  public record InsightReportPatternResponse(String label, long count, double share) {}

  public record SaturationSignalResponse(
      String category, String priceBand, long offerCount, double saturationScore) {}
