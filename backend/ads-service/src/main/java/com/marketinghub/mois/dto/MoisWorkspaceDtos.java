...
public final class MoisWorkspaceDtos {
  ...
  public record WorkspaceKpisResponse(
      int collections, int extractions, int applications, int tests) {}

  public record RecentAnalysisResponse(
      String analysisId, String niche, String status, Instant updatedAt) {}
  ...
  public record ExtractionDraftResponse(
      String extractionId, String referenceId, String status, Instant updatedAt) {}
  ...
  public record LibraryBlockActionResponse(
      String blockId, String action, String status, Instant updatedAt) {}
  ...
  public record ComparisonDimensionResponse(
      String dimension, String market, String current, String highlight) {}

  public record ComparisonScorecardResponse(String metric, int value, String explanation) {}

  public record ComparisonImprovementResponse(
      String improvementId, String priority, String description) {}
  ...
  public record CreateCollectionJobRequest(
      ...
      @NotBlank
          @Pattern(
              regexp = "LAST_7_DAYS|LAST_30_DAYS",
              message = "timeWindow must be LAST_7_DAYS or LAST_30_DAYS")
          String timeWindow,
  ...
  public record CollectedReferenceListResponse(
      String jobId, List<CollectedReferenceResponse> items) {}
