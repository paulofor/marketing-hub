...
public class MoisModuleGateway {
  ...
  public MoisModuleGateway(
      MoisModuleProperties properties, RestTemplateBuilder restTemplateBuilder) {
  ...
  public MoisDiscoveryDtos.DiscoveryRequestAcceptedResponse createDiscoveryRequest(
    ...
    return exchange(
            "/api/v1/mois/discovery-requests",
            HttpMethod.POST,
            request,
            MoisDiscoveryDtos.DiscoveryRequestAcceptedResponse.class)
        .getBody();
  }

  public MoisDiscoveryDtos.DiscoveryRequestListResponse listDiscoveryRequests(
      String status, String nicheName, String marketTheme) {
    ...
    return exchange(
            ...
            HttpMethod.GET,
            null,
            MoisDiscoveryDtos.DiscoveryRequestListResponse.class)
        .getBody();
  }

  public Optional<MoisDiscoveryDtos.DiscoveryRequestDetailResponse> getDiscoveryRequest(
      String requestId) {
    return optionalGet(
        "/api/v1/mois/discovery-requests/" + requestId,
        MoisDiscoveryDtos.DiscoveryRequestDetailResponse.class);
  }

  public MoisDiscoveryDtos.AsyncAcceptedResponse runDiscoveryRequest(String requestId) {
    return exchange(
            "/api/v1/mois/discovery-requests/" + requestId + "/run",
            HttpMethod.POST,
            null,
            MoisDiscoveryDtos.AsyncAcceptedResponse.class)
        .getBody();
  }

  public MoisWorkspaceDtos.WorkspaceDashboardResponse getDashboard(String workspaceId) {
    return exchange(
            "/api/v1/mois/workspaces/" + workspaceId + "/dashboard",
            HttpMethod.GET,
            null,
            MoisWorkspaceDtos.WorkspaceDashboardResponse.class)
        .getBody();
  }

  public MoisWorkspaceDtos.ReferenceResponse createReference(
      MoisWorkspaceDtos.CreateReferenceRequest request) {
    return exchange(
            "/api/v1/mois/references",
            HttpMethod.POST,
            request,
            MoisWorkspaceDtos.ReferenceResponse.class)
        .getBody();
  }
  ...
  public MoisWorkspaceDtos.ReferenceListResponse listReferences(String workspaceId) {
    ...
    return exchange(
            uri.toUriString(), HttpMethod.GET, null, MoisWorkspaceDtos.ReferenceListResponse.class)
        .getBody();
  }

  public MoisWorkspaceDtos.ExtractionDraftResponse upsertExtractionDraft(
      String referenceId, MoisWorkspaceDtos.UpsertExtractionDraftRequest request) {
    return exchange(
            "/api/v1/mois/references/" + referenceId + "/extractions",
            HttpMethod.POST,
            request,
            MoisWorkspaceDtos.ExtractionDraftResponse.class)
        .getBody();
  }

  public MoisWorkspaceDtos.LibraryBlockListResponse listLibraryBlocks(
      String workspaceId, String niche, String formatType) {
    ...
    return exchange(
            ...
            HttpMethod.GET,
            null,
            MoisWorkspaceDtos.LibraryBlockListResponse.class)
        .getBody();
  }

  public Optional<MoisWorkspaceDtos.LibraryBlockActionResponse> favoriteLibraryBlock(
      String blockId) {
    try {
      return Optional.ofNullable(
          exchange(
                  "/api/v1/mois/library/blocks/" + blockId + "/favorite",
                  HttpMethod.POST,
                  null,
                  MoisWorkspaceDtos.LibraryBlockActionResponse.class)
              .getBody());
  ...
  public Optional<MoisWorkspaceDtos.LibraryBlockActionResponse> duplicateLibraryBlock(
      String blockId) {
    try {
      return Optional.ofNullable(
          exchange(
                  "/api/v1/mois/library/blocks/" + blockId + "/duplicate",
                  HttpMethod.POST,
                  null,
                  MoisWorkspaceDtos.LibraryBlockActionResponse.class)
              .getBody());
  ...
  public MoisWorkspaceDtos.ComparisonResponse createComparison(
      MoisWorkspaceDtos.CreateComparisonRequest request) {
    return exchange(
            "/api/v1/mois/comparisons",
            HttpMethod.POST,
            request,
            MoisWorkspaceDtos.ComparisonResponse.class)
        .getBody();
  }

  public MoisWorkspaceDtos.BuildOfferResponse buildOffer(
      MoisWorkspaceDtos.BuildOfferRequest request) {
    return exchange(
            "/api/v1/mois/offers/build",
            HttpMethod.POST,
            request,
            MoisWorkspaceDtos.BuildOfferResponse.class)
        .getBody();
  }

  public MoisOfferDtos.OfferCardListResponse listOffers(
      String requestId, String nicheName, String sellerOrBrand) {
    ...
    return exchange(
            uri.toUriString(), HttpMethod.GET, null, MoisOfferDtos.OfferCardListResponse.class)
        .getBody();
  }
  ...
  public MoisInsightDtos.InsightReportListResponse listInsightReports(
      String requestId, String nicheName, String category) {
    ...
    return exchange(
            ...
            HttpMethod.GET,
            null,
            MoisInsightDtos.InsightReportListResponse.class)
        .getBody();
  }

  public Optional<MoisInsightDtos.InsightReportResponse> getInsightReport(String reportId) {
    return optionalGet(
        "/api/v1/mois/insight-reports/" + reportId, MoisInsightDtos.InsightReportResponse.class);
  }

  public Optional<MoisInsightDtos.InsightExecutiveSummaryResponse> getInsightExecutiveSummary(
      String reportId) {
    return optionalGet(
        "/api/v1/mois/insight-reports/" + reportId + "/executive-summary",
  ...
  public Optional<MoisArtifactDtos.ArtifactEnvelopeResponse> getArtifact(String artifactId) {
    return optionalGet(
        "/api/v1/mois/artifacts/" + artifactId, MoisArtifactDtos.ArtifactEnvelopeResponse.class);
  }

  public MoisWorkspaceDtos.CollectionJobResponse createCollectionJob(
      MoisWorkspaceDtos.CreateCollectionJobRequest request) {
    return exchange(
            "/api/v1/mois/collection-jobs",
            HttpMethod.POST,
            request,
            MoisWorkspaceDtos.CollectionJobResponse.class)
        .getBody();
  }
  ...
  public MoisWorkspaceDtos.CollectionJobListResponse listCollectionJobs(
    ...
    return exchange(
            ...
            HttpMethod.GET,
            null,
            MoisWorkspaceDtos.CollectionJobListResponse.class)
        .getBody();
  }

  public Optional<MoisWorkspaceDtos.CollectedReferenceListResponse> listCollectedReferencesByJob(
      String jobId, String source, String niche, Integer minSuccessScore, String confidenceLevel) {
    UriComponentsBuilder uri =
        UriComponentsBuilder.fromPath("/api/v1/mois/collection-jobs/" + jobId + "/references");
    ...
    return optionalGet(uri.toUriString(), MoisWorkspaceDtos.CollectedReferenceListResponse.class);
  }

  public Optional<MoisWorkspaceDtos.CollectedReferenceActionResponse> favoriteCollectedReference(
      String jobId, String referenceId) {
    try {
      return Optional.ofNullable(
          exchange(
                  "/api/v1/mois/collection-jobs/"
  ...
  public Optional<MoisWorkspaceDtos.CollectedReferenceActionResponse> discardCollectedReference(
      String jobId, String referenceId) {
    try {
      return Optional.ofNullable(
          exchange(
  ...
  public Optional<MoisWorkspaceDtos.CollectedReferenceActionResponse> importCollectedReference(
      String jobId, String referenceId) {
    try {
      return Optional.ofNullable(
          exchange(
  ...
  public Optional<MoisWorkspaceDtos.CollectedReferenceActionResponse> importAndStartExtraction(
      String jobId, String referenceId) {
    try {
      return Optional.ofNullable(
          exchange(
  ...
  public Optional<MoisWorkspaceDtos.CollectedReferenceLineageResponse> getCollectedReferenceLineage(
      String jobId, String referenceId) {
    return optionalGet(
  ...
  public MoisWorkspaceDtos.CollectionOpsSummaryResponse getCollectionOpsSummary(
      String workspaceId) {
    return exchange(
            "/api/v1/mois/workspaces/" + workspaceId + "/collection-ops/summary",
            HttpMethod.GET,
            null,
            MoisWorkspaceDtos.CollectionOpsSummaryResponse.class)
        .getBody();
  }
  ...
  private <T> ResponseEntity<T> exchange(
    ...
    try {
      ...
      throw new org.springframework.web.server.ResponseStatusException(
          HttpStatus.BAD_GATEWAY, "mois module unavailable", ex);
    }
  }
