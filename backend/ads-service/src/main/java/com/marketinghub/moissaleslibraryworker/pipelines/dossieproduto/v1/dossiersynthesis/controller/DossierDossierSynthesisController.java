...
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/dossier-synthesis/stage-executions")
...
public class DossierDossierSynthesisController {
  ...
  public DossierDossierSynthesisPendingResponse pending(
      @Valid @RequestBody DossierDossierSynthesisPendingRequest request) {
