...
public class DossierDossierSynthesisService {
  ...
  public DossierDossierSynthesisRecebeRequestResponse recebeRequest(
      String productKey, String jobId, DossierDossierSynthesisRecebeRequestRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    var page =
        salesPageRepository
    ...
    return new DossierDossierSynthesisRecebeRequestResponse(
  ...
  public DossierDossierSynthesisRecebeResponseResponse recebeResponse(
      String productKey, String jobId, DossierDossierSynthesisRecebeResponseRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    ...
    return new DossierDossierSynthesisRecebeResponseResponse(
   ...
   * mais antiga.
   */
  public DossierDossierSynthesisPendingResponse pending(
      DossierDossierSynthesisPendingRequest request) {
    List<DossierDossierSynthesisPendingJob> jobs =
        salesPageRepository
