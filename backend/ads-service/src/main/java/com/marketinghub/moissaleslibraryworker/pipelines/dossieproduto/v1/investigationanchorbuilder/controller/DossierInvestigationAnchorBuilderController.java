...
/**
 * Expõe a borda HTTP interna da etapa geração de âncoras de investigação do pipeline de dossiê MOIS
 * v1.
 */
@RestController
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/investigation-anchor-builder/stage-executions")
...
public class DossierInvestigationAnchorBuilderController {
  ...
  public DossierInvestigationAnchorBuilderPendingResponse pending(
      @Valid @RequestBody DossierInvestigationAnchorBuilderPendingRequest request) {
