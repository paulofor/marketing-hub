...
/**
 * Publica pendências e contratos da etapa geração de âncoras de investigação do pipeline de dossiê
 * MOIS v1.
 */
@Service
public class DossierInvestigationAnchorBuilderService {
  ...
  public DossierInvestigationAnchorBuilderRecebeRequestResponse recebeRequest(
      String productKey,
      String jobId,
      DossierInvestigationAnchorBuilderRecebeRequestRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    var page =
        salesPageRepository
    ...
    return new DossierInvestigationAnchorBuilderRecebeRequestResponse(
  ...
  public DossierInvestigationAnchorBuilderRecebeResponseResponse recebeResponse(
      String productKey,
      String jobId,
      DossierInvestigationAnchorBuilderRecebeResponseRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    ...
    return new DossierInvestigationAnchorBuilderRecebeResponseResponse(
   ...
   * mais antiga.
   */
  public DossierInvestigationAnchorBuilderPendingResponse pending(
      DossierInvestigationAnchorBuilderPendingRequest request) {
    List<DossierInvestigationAnchorBuilderPendingJob> jobs =
        salesPageRepository
