...
/**
 * Contrato de solicitação do endpoint pending da etapa geração de âncoras de investigação do dossiê
 * MOIS v1.
 */
public record DossierInvestigationAnchorBuilderPendingRequest(
