...
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/product-understanding/stage-executions")
...
public class DossierProductUnderstandingController {
  ...
  public DossierProductUnderstandingPendingResponse pending(
      @Valid @RequestBody DossierProductUnderstandingPendingRequest request) {
