...
public class DossierProductUnderstandingService {
  ...
  public DossierProductUnderstandingRecebeRequestResponse recebeRequest(
      String productKey, String jobId, DossierProductUnderstandingRecebeRequestRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    var page =
        salesPageRepository
    ...
    return new DossierProductUnderstandingRecebeRequestResponse(
  ...
  public DossierProductUnderstandingRecebeResponseResponse recebeResponse(
      String productKey, String jobId, DossierProductUnderstandingRecebeResponseRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    ...
    return new DossierProductUnderstandingRecebeResponseResponse(
   ...
   * mais antiga.
   */
  public DossierProductUnderstandingPendingResponse pending(
      DossierProductUnderstandingPendingRequest request) {
    List<DossierProductUnderstandingPendingJob> jobs =
        salesPageRepository
                ...
                page -> {
                  ...
                  Map<String, Object> input =
                      new java.util.LinkedHashMap<>(
                          productContextGateway
                              .findContext(page.getId())
