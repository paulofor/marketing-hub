...
/**
 * Expõe a borda HTTP interna da etapa validação de relação fonte-produto do pipeline de dossiê MOIS
 * v1.
 */
@RestController
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/source-product-match/stage-executions")
...
public class DossierSourceProductMatchController {
  ...
  public DossierSourceProductMatchPendingResponse pending(
      @Valid @RequestBody DossierSourceProductMatchPendingRequest request) {
