...
/**
 * Publica pendências e contratos da etapa validação de relação fonte-produto do pipeline de dossiê
 * MOIS v1.
 */
@Service
public class DossierSourceProductMatchService {
  ...
  public DossierSourceProductMatchRecebeRequestResponse recebeRequest(
      String productKey, String jobId, DossierSourceProductMatchRecebeRequestRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    var page =
        salesPageRepository
    ...
    return new DossierSourceProductMatchRecebeRequestResponse(
  ...
  public DossierSourceProductMatchRecebeResponseResponse recebeResponse(
      String productKey, String jobId, DossierSourceProductMatchRecebeResponseRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    ...
    return new DossierSourceProductMatchRecebeResponseResponse(
   ...
   * mais antiga.
   */
  public DossierSourceProductMatchPendingResponse pending(
      DossierSourceProductMatchPendingRequest request) {
    List<DossierSourceProductMatchPendingJob> jobs =
        salesPageRepository
