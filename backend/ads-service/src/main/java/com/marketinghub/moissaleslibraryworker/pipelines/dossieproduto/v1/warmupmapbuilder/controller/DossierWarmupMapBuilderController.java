...
/**
 * Expõe a borda HTTP interna da etapa montagem do mapa de aquecimento do pipeline de dossiê MOIS
 * v1.
 */
@RestController
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/warmup-map-builder/stage-executions")
...
public class DossierWarmupMapBuilderController {
  ...
  public DossierWarmupMapBuilderPendingResponse pending(
      @Valid @RequestBody DossierWarmupMapBuilderPendingRequest request) {
