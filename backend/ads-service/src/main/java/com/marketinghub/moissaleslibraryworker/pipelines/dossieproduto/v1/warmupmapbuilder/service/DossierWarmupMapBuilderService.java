...
/**
 * Publica pendências e contratos da etapa montagem do mapa de aquecimento do pipeline de dossiê
 * MOIS v1.
 */
@Service
public class DossierWarmupMapBuilderService {
  ...
  public DossierWarmupMapBuilderRecebeRequestResponse recebeRequest(
      String productKey, String jobId, DossierWarmupMapBuilderRecebeRequestRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    var page =
        salesPageRepository
    ...
    return new DossierWarmupMapBuilderRecebeRequestResponse(
  ...
  public DossierWarmupMapBuilderRecebeResponseResponse recebeResponse(
      String productKey, String jobId, DossierWarmupMapBuilderRecebeResponseRequest request) {
    long pageId = Long.parseLong(productKey);
    Instant now = Instant.now();
    ...
    return new DossierWarmupMapBuilderRecebeResponseResponse(
   ...
   * mais antiga.
   */
  public DossierWarmupMapBuilderPendingResponse pending(
      DossierWarmupMapBuilderPendingRequest request) {
    List<DossierWarmupMapBuilderPendingJob> jobs =
        salesPageRepository
