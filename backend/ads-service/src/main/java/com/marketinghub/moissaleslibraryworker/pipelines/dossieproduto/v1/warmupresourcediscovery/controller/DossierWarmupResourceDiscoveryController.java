...
/**
 * Expõe a borda HTTP interna da etapa descoberta de recursos de aquecimento do pipeline de dossiê
 * MOIS v1.
 */
@RestController
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/warmup-resource-discovery/stage-executions")
...
public class DossierWarmupResourceDiscoveryController {
  ...
  public DossierWarmupResourceDiscoveryPendingResponse pending(
      @Valid @RequestBody DossierWarmupResourceDiscoveryPendingRequest request) {
