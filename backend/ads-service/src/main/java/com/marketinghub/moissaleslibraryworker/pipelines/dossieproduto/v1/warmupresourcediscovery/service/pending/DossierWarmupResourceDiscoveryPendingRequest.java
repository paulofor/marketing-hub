...
/**
 * Contrato de solicitação do endpoint pending da etapa descoberta de recursos de aquecimento do
 * dossiê MOIS v1.
 */
public record DossierWarmupResourceDiscoveryPendingRequest(
