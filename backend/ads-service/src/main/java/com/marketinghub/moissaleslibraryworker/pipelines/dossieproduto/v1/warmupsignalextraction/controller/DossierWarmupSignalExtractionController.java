...
/**
 * Expõe a borda HTTP interna da etapa extração de sinais de aquecimento do pipeline de dossiê MOIS
 * v1.
 */
@RestController
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/dossieproduto/v1/warmup-signal-extraction/stage-executions")
...
public class DossierWarmupSignalExtractionController {
  ...
  public DossierWarmupSignalExtractionPendingResponse pending(
      @Valid @RequestBody DossierWarmupSignalExtractionPendingRequest request) {
