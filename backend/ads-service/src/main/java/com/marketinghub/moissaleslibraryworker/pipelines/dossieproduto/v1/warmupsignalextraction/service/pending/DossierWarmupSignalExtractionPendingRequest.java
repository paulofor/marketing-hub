...
/**
 * Contrato de solicitação do endpoint pending da etapa extração de sinais de aquecimento do dossiê
 * MOIS v1.
 */
public record DossierWarmupSignalExtractionPendingRequest(
