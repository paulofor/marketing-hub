...
@Slf4j
@RequestMapping(
    "/api/internal/moissaleslibraryworker/salespagepatterns/v1/page-pattern-extraction/stage-executions")
...
public class SalesPagePatternsPagePatternExtractionController {
  ...
  public SalesPagePatternsPagePatternExtractionRecebeResponseResponse recebeResponse(
    ...
    log.info(
        "Recebendo response salespagepatterns.v1: etapa={}, idExterno={}, jobId={}, payload={}",
