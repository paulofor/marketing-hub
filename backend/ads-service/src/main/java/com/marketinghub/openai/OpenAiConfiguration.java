...
public class OpenAiConfiguration {
  ...
  public WebClient openAiWebClient(
      WebClient.Builder builder, OpenAiProperties properties, OpenAiApiKeyResolver apiKeyResolver) {
    ...
    ExchangeStrategies exchangeStrategies =
        ExchangeStrategies.builder()
            .codecs(
                configurer ->
                    configurer.defaultCodecs().maxInMemorySize(OPENAI_MAX_IN_MEMORY_BYTES))
            .build();
