...
/**
 * Estimates the approximate cost of an OpenAI Responses API call using published prices per 1K
 * tokens.
 */
public final class OpenAiCostEstimator {
  private static final BigDecimal ONE_THOUSAND = BigDecimal.valueOf(1000);

  private static final Map<String, Pricing> PRICING_BY_MODEL =
      Map.ofEntries(
          Map.entry(
              "gpt-3.5-turbo", new Pricing(new BigDecimal("0.0005"), new BigDecimal("0.0015"))),
          Map.entry("gpt-4o", new Pricing(new BigDecimal("0.005"), new BigDecimal("0.015"))),
          Map.entry(
              "gpt-4o-mini", new Pricing(new BigDecimal("0.00015"), new BigDecimal("0.0006"))),
