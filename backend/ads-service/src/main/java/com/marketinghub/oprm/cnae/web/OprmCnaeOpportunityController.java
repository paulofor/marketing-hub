...
public class OprmCnaeOpportunityController {
  ...
  public List<OprmCnaeOpportunityCandidateDto> listMissingScores(
  ...
  public OprmCnaeCycleResponseDto createCycle(
  ...
  public OprmCnaeCycleResponseDto updateCycle(
      @PathVariable String cycleId, @Valid @RequestBody OprmCnaeCycleUpsertRequestDto request) {
    return service.upsertCycle(
        new OprmCnaeCycleUpsertRequestDto(
            cycleId,
            request.cycleType(),
            request.cycleNumber(),
            request.status(),
  ...
  /**
   * Lista nichos já enriquecidos pelo OPRM em ordem decrescente de score para acompanhamento direto
   * do usuário.
   */
  @GetMapping("/cnae-niche-candidates/enriched")
  public List<OprmNicheCandidateResponseDto> listEnrichedCandidates(
