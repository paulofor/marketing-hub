...
/**
 * Responsável por armazenar dados de público que o Facebook Ads buscará no backend sem acoplamento
 * OPRM-targeting.
 */
@Entity
...
public class OprmGeneralAudienceFacebookAdsData {
  ...
  public OprmGeneralAudienceAdSignalType getSignalType() {
    return signalType;
  }

  /** Define o tipo do sinal de público. */
  public void setSignalType(OprmGeneralAudienceAdSignalType signalType) {
  ...
  public boolean isRequiredForPublication() {
    return requiredForPublication;
  }

  /** Define se o dado é obrigatório antes da publicação. */
  public void setRequiredForPublication(boolean requiredForPublication) {
    this.requiredForPublication = requiredForPublication;
  }

  /** Retorna se o dado está pronto para coleta pelo Facebook Ads. */
  public boolean isReadyForFacebookAds() {
    return readyForFacebookAds;
  }

  /** Define se o dado está pronto para coleta pelo Facebook Ads. */
  public void setReadyForFacebookAds(boolean readyForFacebookAds) {
    this.readyForFacebookAds = readyForFacebookAds;
  }

  /** Retorna o status operacional do dado de público. */
  public OprmGeneralAudienceAdSignalStatus getStatus() {
    return status;
  }

  /** Define o status operacional do dado de público. */
  public void setStatus(OprmGeneralAudienceAdSignalStatus status) {
    this.status = status;
  }

  /** Retorna a frase de triagem sugerida para o criativo. */
  public String getCreativeScreeningPhrase() {
    return creativeScreeningPhrase;
  }

  /** Define a frase de triagem sugerida para o criativo. */
  public void setCreativeScreeningPhrase(String creativeScreeningPhrase) {
    this.creativeScreeningPhrase = creativeScreeningPhrase;
  }

  /** Retorna a orientação demográfica registrada para avaliação posterior. */
  public String getDemographicGuidance() {
    return demographicGuidance;
  }

  /** Define a orientação demográfica registrada para avaliação posterior. */
  public void setDemographicGuidance(String demographicGuidance) {
    this.demographicGuidance = demographicGuidance;
  }

  /** Retorna a instrução de confirmação que deve aparecer na landing. */
  public String getLandingConfirmationInstruction() {
    return landingConfirmationInstruction;
  }
