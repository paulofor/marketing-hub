...
/**
 * Responsável por armazenar a situação de confirmação preparada pelo OPRM para uso posterior por
 * outros módulos.
 */
@Entity
...
public class OprmGeneralAudienceLandingConfirmation {
  ...
  /**
   * Retorna o identificador externo do experimento informado, sem depender do módulo de
   * experimentos.
   */
  ...
  public String getAudienceConfirmationQuestion() {
    return audienceConfirmationQuestion;
  }
  ...
  public String getQualificationOptions() {
    return qualificationOptions;
  }

  /** Define as opções de qualificação separadas por quebra de linha. */
  public void setQualificationOptions(String qualificationOptions) {
    this.qualificationOptions = qualificationOptions;
  }

  /** Retorna a pergunta que confirma a dor. */
  public String getPainConfirmationQuestion() {
    return painConfirmationQuestion;
  }
  ...
  public String getWhyItMakesSense() {
    return whyItMakesSense;
  }

  /** Define por que a confirmação faz sentido. */
  public void setWhyItMakesSense(String whyItMakesSense) {
    this.whyItMakesSense = whyItMakesSense;
  }
