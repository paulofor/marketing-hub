...
public class OprmGeneralAudiencePainAngle {
  ...
  public String getMechanismDirection() {
    return mechanismDirection;
  }

  /** Define a direção de mecanismo plausível para resolver a dor. */
  public void setMechanismDirection(String mechanismDirection) {
    this.mechanismDirection = mechanismDirection;
  }

  /** Retorna a prova ou isca sugerida para teste futuro. */
  public String getProofOrLeadMagnet() {
    return proofOrLeadMagnet;
  }

  /** Define a prova ou isca sugerida para teste futuro. */
  public void setProofOrLeadMagnet(String proofOrLeadMagnet) {
    this.proofOrLeadMagnet = proofOrLeadMagnet;
  }
  ...
  public String getFirstAdHook() {
    return firstAdHook;
  }

  /** Define o primeiro gancho de anúncio sugerido. */
  public void setFirstAdHook(String firstAdHook) {
    this.firstAdHook = firstAdHook;
  }

  /** Retorna a pergunta de confirmação da landing. */
  public String getLandingConfirmationQuestion() {
    return landingConfirmationQuestion;
  }

  /** Define a pergunta de confirmação da landing. */
  public void setLandingConfirmationQuestion(String landingConfirmationQuestion) {
    this.landingConfirmationQuestion = landingConfirmationQuestion;
  }
  ...
  public OprmGeneralAudiencePainAngleStatus getStatus() {
    return status;
  }

  /** Define o status de revisão do ângulo. */
  public void setStatus(OprmGeneralAudiencePainAngleStatus status) {
    this.status = status;
  }
