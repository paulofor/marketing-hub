...
public class OprmGeneralAudienceQualityReading {
  ...
  public OprmGeneralAudienceSubniche getSubniche() {
    return subniche;
  }

  /** Define o subnicho avaliado. */
  public void setSubniche(OprmGeneralAudienceSubniche subniche) {
    this.subniche = subniche;
  }

  /** Retorna o ângulo relacionado à leitura. */
  public OprmGeneralAudiencePainAngle getPainAngle() {
    return painAngle;
  }

  /** Define o ângulo relacionado à leitura. */
  public void setPainAngle(OprmGeneralAudiencePainAngle painAngle) {
    this.painAngle = painAngle;
  }
  ...
  public Integer getCorrectProfessionLeads() {
    return correctProfessionLeads;
  }

  /** Define quantos leads informaram a profissão correta. */
  public void setCorrectProfessionLeads(Integer correctProfessionLeads) {
    this.correctProfessionLeads = correctProfessionLeads;
  }

  /** Retorna quantas respostas trouxeram dor real. */
  public Integer getRealPainResponses() {
    return realPainResponses;
  }

  /** Define quantas respostas trouxeram dor real. */
  public void setRealPainResponses(Integer realPainResponses) {
    this.realPainResponses = realPainResponses;
  }

  /** Retorna quantas pessoas pediram o material. */
  public Integer getMaterialRequests() {
    return materialRequests;
  }

  /** Define quantas pessoas pediram o material. */
  public void setMaterialRequests(Integer materialRequests) {
    this.materialRequests = materialRequests;
  }

  /** Retorna quantas pessoas responderam no WhatsApp. */
  public Integer getWhatsappReplies() {
    return whatsappReplies;
  }

  /** Define quantas pessoas responderam no WhatsApp. */
  public void setWhatsappReplies(Integer whatsappReplies) {
    this.whatsappReplies = whatsappReplies;
  }

  /** Retorna quantas pessoas perguntaram preço ou próximo passo. */
  public Integer getPriceOrNextStepQuestions() {
    return priceOrNextStepQuestions;
  }

  /** Define quantas pessoas perguntaram preço ou próximo passo. */
  public void setPriceOrNextStepQuestions(Integer priceOrNextStepQuestions) {
    this.priceOrNextStepQuestions = priceOrNextStepQuestions;
  }

  /** Retorna quantos leads vieram fora do perfil. */
  public Integer getOutOfProfileLeads() {
    return outOfProfileLeads;
  }

  /** Define quantos leads vieram fora do perfil. */
  public void setOutOfProfileLeads(Integer outOfProfileLeads) {
    this.outOfProfileLeads = outOfProfileLeads;
  }

  /** Retorna quantos curiosos vieram sem profissão aderente. */
  public Integer getCuriousWithoutProfession() {
    return curiousWithoutProfession;
  }

  /** Define quantos curiosos vieram sem profissão aderente. */
  public void setCuriousWithoutProfession(Integer curiousWithoutProfession) {
    this.curiousWithoutProfession = curiousWithoutProfession;
  }

  /** Retorna quantos eventos indicaram baixo preenchimento. */
  public Integer getLowCompletionEvents() {
    return lowCompletionEvents;
  }

  /** Define quantos eventos indicaram baixo preenchimento. */
  public void setLowCompletionEvents(Integer lowCompletionEvents) {
    this.lowCompletionEvents = lowCompletionEvents;
  }

  /** Retorna quantos relatos apontaram promessa confusa. */
  public Integer getConfusingPromiseReports() {
    return confusingPromiseReports;
  }

  /** Define quantos relatos apontaram promessa confusa. */
  public void setConfusingPromiseReports(Integer confusingPromiseReports) {
    this.confusingPromiseReports = confusingPromiseReports;
  }

  /** Retorna quantos leads baixaram a isca sem responder depois. */
  public Integer getLeadMagnetNoResponse() {
    return leadMagnetNoResponse;
  }

  /** Define quantos leads baixaram a isca sem responder depois. */
  public void setLeadMagnetNoResponse(Integer leadMagnetNoResponse) {
    this.leadMagnetNoResponse = leadMagnetNoResponse;
  }
