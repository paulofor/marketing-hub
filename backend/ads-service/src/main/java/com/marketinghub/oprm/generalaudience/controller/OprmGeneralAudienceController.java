...
public class OprmGeneralAudienceController {
  ...
  public ResponseEntity<GeneralAudienceSeedResponse> createSeed(
    ...
    return ResponseEntity.created(URI.create("/api/oprm/general-audiences/seeds/" + response.id()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudienceSeedResponse> updateSeed(
      @PathVariable Long seedId, @Valid @RequestBody UpdateGeneralAudienceSeedRequest request) {
  ...
  public ResponseEntity<List<GeneralAudienceSubnicheSummaryResponse>> listSubniches(
  ...
  public ResponseEntity<GeneralAudienceSubnicheResponse> createSubniche(
      @PathVariable Long seedId, @Valid @RequestBody CreateGeneralAudienceSubnicheRequest request) {
    GeneralAudienceSubnicheResponse response = service.createSubniche(seedId, request);
    return ResponseEntity.created(
            URI.create("/api/oprm/general-audiences/subniches/" + response.id()))
        .body(response);
  }

  /** Detalha um subnicho de público geral para revisão de persona, dor, canais e triagem. */
  @GetMapping("/subniches/{subnicheId}")
  public ResponseEntity<GeneralAudienceSubnicheResponse> getSubniche(
  ...
  public ResponseEntity<GeneralAudienceSubnicheResponse> approveSubniche(
      @PathVariable Long subnicheId) {
  ...
  public ResponseEntity<GeneralAudienceSubnicheResponse> rejectSubniche(
      @PathVariable Long subnicheId) {
