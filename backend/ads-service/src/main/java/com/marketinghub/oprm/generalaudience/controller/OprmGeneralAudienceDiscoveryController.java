...
public class OprmGeneralAudienceDiscoveryController {
  ...
  public ResponseEntity<List<GeneralAudiencePainAngleResponse>> listPainAngles(
  ...
  public ResponseEntity<GeneralAudiencePainAngleResponse> createPainAngle(
    ...
    return ResponseEntity.created(
            URI.create("/api/oprm/general-audiences/pain-angles/" + response.id()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudiencePainAngleResponse> approvePainAngle(
      @PathVariable Long angleId) {
  ...
  public ResponseEntity<GeneralAudienceHypothesisResponse> createHypothesis(
    ...
    return ResponseEntity.created(URI.create("/api/hypotheses/" + response.hypothesisId()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudienceLeadExperimentResponse> createLeadExperiment(
    ...
    return ResponseEntity.created(URI.create("/api/experiments/" + response.experimentId()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudienceLandingConfirmationResponse> createConfirmationFlow(
    ...
    GeneralAudienceLandingConfirmationResponse response =
        landingConfirmationService.createConfirmationFlow(angleId, request);
    return ResponseEntity.created(
            URI.create(
                "/api/oprm/general-audiences/landing-confirmations/"
                    + response.confirmationRecordId()))
        .body(response);
  }

  /** Lista evidências agregadas associadas à semente de público geral. */
  @GetMapping("/seeds/{seedId}/source-evidences")
  public ResponseEntity<List<GeneralAudienceSourceEvidenceResponse>> listSeedEvidences(
  ...
  public ResponseEntity<GeneralAudienceSourceEvidenceResponse> createSourceEvidence(
    ...
    return ResponseEntity.created(
            URI.create("/api/oprm/general-audiences/source-evidences/" + response.id()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudienceQualityReadingResponse> createQualityReading(
    ...
    GeneralAudienceQualityReadingResponse response =
        service.createQualityReading(subnicheId, request);
    return ResponseEntity.created(
            URI.create("/api/oprm/general-audiences/quality-readings/" + response.id()))
        .body(response);
  }
  ...
  public ResponseEntity<GeneralAudienceQualityGateResponse> evaluateQualityGate(
      @PathVariable Long subnicheId) {
