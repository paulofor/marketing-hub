...
public class BackendEnrichedNicheMaterializerController {
  ...
  public BackendEnrichedNicheMaterializerController(
      BackendEnrichedNicheMaterializerService executionService) {
  ...
  @PostMapping(
      "/api/internal/oprm/nichocnae/enriched-niche-materializer/stage-executions/{researchCycleId}/complete")
  public ResponseEntity<CompleteEnrichedNicheMaterializerResponse> complete(
      @PathVariable Long researchCycleId,
      @RequestBody CompleteEnrichedNicheMaterializerRequest request) {
  ...
  @PostMapping(
      "/api/internal/oprm/nichocnae/enriched-niche-materializer/stage-executions/{researchCycleId}/fail")
  public ResponseEntity<Void> fail(
      @PathVariable Long researchCycleId,
      @RequestBody FailEnrichedNicheMaterializerRequest request) {
  ...
  public ResponseEntity<EnrichedNicheMaterializerDetailResponse> detail(
      @PathVariable Long researchCycleId) {
  ...
  public ResponseEntity<EnrichedNicheMaterializerDetailResponse> detailByProfileId(
  ...
  public List<GeneratedEnrichedNicheByCnaeResponse> listGeneratedByCnae(
      @PathVariable String cnaeCode, @RequestParam(defaultValue = "50") int limit) {
    return executionService.listGeneratedByCnae(cnaeCode, limit);
  }

  /**
   * Entrega um documento Markdown baixável com auditoria de todo o pipeline processado para o
   * perfil.
   */
  @GetMapping(
      value =
  ...
  @GetMapping(
      ...
      produces = "text/markdown;charset=UTF-8")
  public ResponseEntity<String> downloadPipelineMarkdownByResearchCycleId(
      @PathVariable Long researchCycleId) {
