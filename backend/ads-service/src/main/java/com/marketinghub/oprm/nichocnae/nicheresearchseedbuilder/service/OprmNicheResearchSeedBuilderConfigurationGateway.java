...
/**
 * Define o contrato OPRM para consultar configuração de IA e custo da etapa dois sem depender de
 * pacotes externos.
 */
public interface OprmNicheResearchSeedBuilderConfigurationGateway {
  ...
  /**
   * Estima o custo da chamada de IA usada pela etapa dois a partir do modelo e dos tokens
   * informados.
   */
