...
public class BackendRoutineResearchOrchestratorController {
  ...
  public BackendRoutineResearchOrchestratorController(
      BackendRoutineResearchOrchestratorService executionService) {
  ...
  /**
   * Lista jobs por status para o executor decidir nova tentativa usando aprendizado da tentativa
   * anterior.
   */
  ...
  public List<RecordRoutineResearchOrchestratorRecent> jobsByStatus(
      @RequestParam("status") List<String> statuses, @RequestParam(defaultValue = "20") int limit) {
  ...
  @PostMapping(
      "/oprm/nichocnae/routine-research-orchestrator/recent-processed/{researchCycleId}/reprocess")
  ...
  public ResponseEntity<RecordRoutineResearchOrchestratorResult> runForCnae(
