...
public class BackendAdaptiveQueryPlannerController {
  ...
  @PostMapping
  public AdaptiveQueryPlannerCreateResponse create(
      @RequestBody AdaptiveQueryPlannerCreateRequest request) {
  ...
  public AdaptiveQueryPlannerCompletionResponse complete(
      ...
      @RequestBody AdaptiveQueryPlannerCompletionRequest request) {
  ...
  public AdaptiveQueryPlannerFailureResponse fail(
      @PathVariable Long stageExecutionId,
      @RequestBody AdaptiveQueryPlannerFailureRequest request) {
