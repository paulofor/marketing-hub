...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa adaptive-query-planner do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendAdaptiveQueryPlannerService {
  ...
  public AdaptiveQueryPlannerFailureResponse fail(
      Long stageExecutionId, AdaptiveQueryPlannerFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
  ...
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      AdaptiveQueryPlannerCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new AdaptiveQueryPlannerCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 adaptive-query-planner stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private AdaptiveQueryPlannerPendingResponse toPendingResponse(
