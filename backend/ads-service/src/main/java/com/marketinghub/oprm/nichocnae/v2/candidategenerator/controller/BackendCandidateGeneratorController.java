...
public class BackendCandidateGeneratorController {
  ...
  /**
   * Confirma o nome único e transforma o job concluído em nicho de mercado para a sequência do
   * Marketing Hub.
   */
  @PostMapping("/jobs/{jobId}/confirm-niche")
  public CandidateGeneratorConfirmNicheResponse confirmNiche(
      @PathVariable String jobId,
      @RequestBody(required = false) CandidateGeneratorConfirmNicheRequest request) {
  ...
  public CandidateGeneratorCompletionResponse complete(
      ...
      @RequestBody CandidateGeneratorCompletionRequest request) {
