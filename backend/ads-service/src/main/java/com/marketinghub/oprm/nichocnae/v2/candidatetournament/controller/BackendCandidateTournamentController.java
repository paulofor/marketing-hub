...
public class BackendCandidateTournamentController {
  ...
  @PostMapping
  public CandidateTournamentCreateResponse create(
      @RequestBody CandidateTournamentCreateRequest request) {
  ...
  public CandidateTournamentCompletionResponse complete(
      ...
      @RequestBody CandidateTournamentCompletionRequest request) {
