...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa candidate-tournament do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendCandidateTournamentService {
  ...
  public CandidateTournamentFailureResponse fail(
      Long stageExecutionId, CandidateTournamentFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
  ...
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      CandidateTournamentCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new CandidateTournamentCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 candidate-tournament stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private CandidateTournamentPendingResponse toPendingResponse(
