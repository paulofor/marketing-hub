...
public class BackendCommercialEvidenceGateController {
  ...
  @PostMapping
  public CommercialEvidenceGateCreateResponse create(
      @RequestBody CommercialEvidenceGateCreateRequest request) {
  ...
  public CommercialEvidenceGateCompletionResponse complete(
      ...
      @RequestBody CommercialEvidenceGateCompletionRequest request) {
  ...
  public CommercialEvidenceGateFailureResponse fail(
      @PathVariable Long stageExecutionId,
      @RequestBody CommercialEvidenceGateFailureRequest request) {
