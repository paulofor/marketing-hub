...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa commercial-evidence-gate do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendCommercialEvidenceGateService {
  ...
  public CommercialEvidenceGateFailureResponse fail(
      Long stageExecutionId, CommercialEvidenceGateFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
  ...
  public CommercialEvidenceGateCreateResponse create(CommercialEvidenceGateCreateRequest request) {
    ...
    return new CommercialEvidenceGateCreateResponse(
  ...
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      CommercialEvidenceGateCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new CommercialEvidenceGateCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 commercial-evidence-gate stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private CommercialEvidenceGatePendingResponse toPendingResponse(
      OprmNichoCnaeV2StageExecution execution) {
    return new CommercialEvidenceGatePendingResponse(
        String.valueOf(execution.getId()),
        execution.getJobId(),
