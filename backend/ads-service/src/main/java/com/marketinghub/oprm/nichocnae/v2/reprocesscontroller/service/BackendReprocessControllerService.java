...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa reprocess-controller do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendReprocessControllerService {
  ...
  public ReprocessControllerCreateResponse create(ReprocessControllerCreateRequest request) {
    OprmNichoCnaeV2StageExecution saved =
        stageExecutionRepository.save(toPendingExecution(request));
    return new ReprocessControllerCreateResponse(
  ...
  public ReprocessControllerCompletionResponse complete(
      Long stageExecutionId, ReprocessControllerCompletionRequest request) {
    ...
    return new ReprocessControllerCompletionResponse(
        String.valueOf(saved.getId()),
        saved.getStatus().name(),
        request == null ? null : request.executionMode(),
        request == null ? null : request.rewindToStage(),
        request == null ? null : request.knowledgeVersionTo(),
  ...
  public ReprocessControllerFailureResponse fail(
      Long stageExecutionId, ReprocessControllerFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
    ...
    if (failureType == OprmNichoCnaeV2FailureType.INFRASTRUCTURE) {
      ...
      return new ReprocessControllerFailureResponse(
  ...
  /**
   * Converte o contrato recebido do executor em entidade persistível, sem decidir regra
   * operacional.
   */
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      ReprocessControllerCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new ReprocessControllerCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 reprocess-controller stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private ReprocessControllerPendingResponse toPendingResponse(
