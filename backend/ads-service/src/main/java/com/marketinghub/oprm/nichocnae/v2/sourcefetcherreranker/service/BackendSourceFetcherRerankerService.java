...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa source-fetcher-reranker do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendSourceFetcherRerankerService {
  ...
  /**
   * Registra conclusão da coleta e do reranking usando a próxima etapa informada pelo executor
   * externo.
   */
  @Transactional
  ...
  public SourceFetcherRerankerFailureResponse fail(
      Long stageExecutionId, SourceFetcherRerankerFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
  ...
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      SourceFetcherRerankerCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new SourceFetcherRerankerCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 source-fetcher-reranker stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private SourceFetcherRerankerPendingResponse toPendingResponse(
