...
/**
 * Expõe contratos de leitura/escrita do backend para a etapa source-safety-filter do pipeline
 * NichoCNAE v2.
 */
@Service
public class BackendSourceSafetyFilterService {
  ...
  public SourceSafetyFilterFailureResponse fail(
      Long stageExecutionId, SourceSafetyFilterFailureRequest request) {
    OprmNichoCnaeV2StageExecution execution = findExecution(stageExecutionId);
  ...
  private OprmNichoCnaeV2StageExecution toPendingExecution(
      SourceSafetyFilterCreateRequest request) {
  ...
  private OprmNichoCnaeV2StageExecution createTechnicalRetry(
    ...
    OprmNichoCnaeV2StageExecution retry =
        toPendingExecution(
            new SourceSafetyFilterCreateRequest(
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    ...
                    "NichoCNAE v2 source-safety-filter stage execution not found: "
                        + stageExecutionId));
  }
  ...
  private SourceSafetyFilterPendingResponse toPendingResponse(
