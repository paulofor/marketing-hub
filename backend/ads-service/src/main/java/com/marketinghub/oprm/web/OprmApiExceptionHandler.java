...
public class OprmApiExceptionHandler {
  ...
  public ResponseEntity<OprmApiErrorResponseDto> handleResponseStatus(
    ...
    return buildResponse(
        exception.getStatusCode().value(), errorCode, exception.getReason(), request, null);
  }
  ...
  private ResponseEntity<OprmApiErrorResponseDto> buildResponse(
      int statusCode, String code, String message, HttpServletRequest request, String details) {
    String correlationId = request.getHeader("X-Correlation-Id");
    OprmApiErrorResponseDto response =
        new OprmApiErrorResponseDto(
            code, message == null ? "erro na requisição OPRM" : message, correlationId, details);
