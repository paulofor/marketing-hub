...
public class OprmNichoCnaeV3StageExecution {
  ...
  public OprmNichoCnaeV3StageExecutionStatus getStatus() {
    return status;
  }

  /** Define o status operacional. */
  public void setStatus(OprmNichoCnaeV3StageExecutionStatus status) {
    this.status = status;
  }
  ...
  public Integer getKnowledgeVersion() {
    return knowledgeVersion;
  }

  /** Define a versão de conhecimento. */
  public void setKnowledgeVersion(Integer knowledgeVersion) {
