...
@RestController
@RequestMapping(
    "/api/internal/oprmcoletormei/nichocnae/v3/daily-tasks-synthesizer/stage-executions")
public class BackendDailyTasksSynthesizerController {
  private static final Logger log =
      LoggerFactory.getLogger(BackendDailyTasksSynthesizerController.class);
  ...
  @PostMapping
  public DailyTasksSynthesizerCreateResponse create(
      @RequestBody DailyTasksSynthesizerPendingResponse request) {
  ...
  public DailyTasksSynthesizerCreateResponse recebeRequest(
  ...
  public DailyTasksSynthesizerCreateResponse complete(
      @PathVariable Long stageExecutionId,
      @RequestBody DailyTasksSynthesizerCompletionRequest request) {
  ...
  public DailyTasksSynthesizerCreateResponse fail(
      @PathVariable Long stageExecutionId,
      @RequestBody DailyTasksSynthesizerFailureRequest request) {
