package com.marketinghub.oprmcoletormei.nichocnae.v3.dailytaskssynthesizer.service.createStageExecution;

/** Resposta de criação de execução pendente da etapa daily-tasks-synthesizer. */
public record DailyTasksSynthesizerCreateResponse(
