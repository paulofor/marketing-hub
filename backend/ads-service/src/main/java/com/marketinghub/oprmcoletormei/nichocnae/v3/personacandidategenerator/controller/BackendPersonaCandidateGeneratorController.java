...
@RestController
@RequestMapping(
    "/api/internal/oprmcoletormei/nichocnae/v3/persona-candidate-generator/stage-executions")
public class BackendPersonaCandidateGeneratorController {
  private static final Logger log =
      LoggerFactory.getLogger(BackendPersonaCandidateGeneratorController.class);
  private final BackendPersonaCandidateGeneratorService service;

  /** Inicializa o controller com service canônico da etapa. */
  public BackendPersonaCandidateGeneratorController(
      BackendPersonaCandidateGeneratorService service) {
  ...
  @PostMapping
  public PersonaCandidateGeneratorCreateResponse create(
      @RequestBody PersonaCandidateGeneratorPendingResponse request) {
  ...
  public PersonaCandidateGeneratorCreateResponse recebeRequest(
  ...
  public PersonaCandidateGeneratorCreateResponse complete(
      @PathVariable Long stageExecutionId,
      @RequestBody PersonaCandidateGeneratorCompletionRequest request) {
  ...
  public PersonaCandidateGeneratorCreateResponse fail(
      @PathVariable Long stageExecutionId,
      @RequestBody PersonaCandidateGeneratorFailureRequest request) {
