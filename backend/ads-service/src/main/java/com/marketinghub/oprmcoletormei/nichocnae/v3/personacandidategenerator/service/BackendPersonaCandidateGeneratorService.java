...
public class BackendPersonaCandidateGeneratorService extends OprmNichoCnaeV3StageServiceSupport {
  ...
  public BackendPersonaCandidateGeneratorService(
  ...
  public PersonaCandidateGeneratorCreateResponse recebeRequest(
    ...
    return new PersonaCandidateGeneratorCreateResponse(
        null,
  ...
  private PersonaCandidateGeneratorCreateResponse toCreateResponse(
