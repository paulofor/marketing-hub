...
/**
 * Porta exclusiva da etapa persona-routine-materializer v3 para materializar dados reutilizáveis de
 * nicho.
 */
public interface PersonaRoutineMaterializerNicheGateway {
  ...
  Optional<MarketNicheSnapshot> findPersonaRoutineMaterializedNiche(
  ...
  NicheMaterializationResult materialize(
      MarketNicheDraft nicheDraft, EnrichedNicheProfileDraft profileDraft);
  ...
  record NicheMaterializationResult(
      Long marketNicheId, Long enrichmentProfileId, Instant createdAt) {}
}
