...
public class BackendPersonaTournamentController {
  private static final Logger log =
      LoggerFactory.getLogger(BackendPersonaTournamentController.class);
  ...
  @PostMapping
  public PersonaTournamentCreateResponse create(
      @RequestBody PersonaTournamentPendingResponse request) {
  ...
  public PersonaTournamentCreateResponse recebeRequest(
  ...
  public PersonaTournamentCreateResponse complete(
      @PathVariable Long stageExecutionId,
      @RequestBody PersonaTournamentCompletionRequest request) {
  ...
  public PersonaTournamentCreateResponse fail(
      @PathVariable Long stageExecutionId, @RequestBody PersonaTournamentFailureRequest request) {
