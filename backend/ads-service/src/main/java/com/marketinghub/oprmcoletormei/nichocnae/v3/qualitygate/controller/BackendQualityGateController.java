...
public class BackendQualityGateController {
  ...
  public QualityGateCreateResponse recebeRequest(
  ...
  public QualityGateCreateResponse complete(
      @PathVariable Long stageExecutionId, @RequestBody QualityGateCompletionRequest request) {
  ...
  public QualityGateCreateResponse fail(
      @PathVariable Long stageExecutionId, @RequestBody QualityGateFailureRequest request) {
