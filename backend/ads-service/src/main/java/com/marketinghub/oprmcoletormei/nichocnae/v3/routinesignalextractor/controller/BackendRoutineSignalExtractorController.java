...
@RestController
@RequestMapping(
    "/api/internal/oprmcoletormei/nichocnae/v3/routine-signal-extractor/stage-executions")
public class BackendRoutineSignalExtractorController {
  private static final Logger log =
      LoggerFactory.getLogger(BackendRoutineSignalExtractorController.class);
  ...
  @PostMapping
  public RoutineSignalExtractorCreateResponse create(
      @RequestBody RoutineSignalExtractorPendingResponse request) {
  ...
  public RoutineSignalExtractorCreateResponse recebeRequest(
  ...
  public RoutineSignalExtractorCreateResponse complete(
      @PathVariable Long stageExecutionId,
      @RequestBody RoutineSignalExtractorCompletionRequest request) {
  ...
  public RoutineSignalExtractorCreateResponse fail(
      @PathVariable Long stageExecutionId,
      @RequestBody RoutineSignalExtractorFailureRequest request) {
