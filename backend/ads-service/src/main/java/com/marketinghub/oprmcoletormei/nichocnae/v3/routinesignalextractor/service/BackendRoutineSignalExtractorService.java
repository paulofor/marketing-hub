...
public class BackendRoutineSignalExtractorService extends OprmNichoCnaeV3StageServiceSupport {
    ...
    public BackendRoutineSignalExtractorService(OprmNichoCnaeV3StageExecutionRepository repository, OprmCnpjCnaeDimRepository cnaeRepository, PipelineNichoCnaeRepository pipelineNichoCnaeRepository, OpenAiPricingService openAiPricingService) {
