...
public class BackendRoutineSignalExtractorService extends OprmNichoCnaeV3StageServiceSupport {
  ...
  public BackendRoutineSignalExtractorService(
  ...
  public RoutineSignalExtractorCreateResponse recebeRequest(
    ...
    return new RoutineSignalExtractorCreateResponse(
        null,
  ...
  private RoutineSignalExtractorCreateResponse toCreateResponse(
