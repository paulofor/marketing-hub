package com.marketinghub.oprmcoletormei.nichocnae.v3.routinesignalextractor.service.createStageExecution;

/** Resposta de criação de execução pendente da etapa routine-signal-extractor. */
public record RoutineSignalExtractorCreateResponse(
