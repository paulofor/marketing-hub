...
public class BackendSourceFetcherV3Controller {
  ...
  public SourceFetcherCreateResponse recebeRequest(
  ...
  public SourceFetcherCreateResponse complete(
      @PathVariable Long stageExecutionId, @RequestBody SourceFetcherCompletionRequest request) {
  ...
  public SourceFetcherCreateResponse fail(
      @PathVariable Long stageExecutionId, @RequestBody SourceFetcherFailureRequest request) {
