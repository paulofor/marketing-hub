...
public class OpsMonitorController {
  ...
  public RegisterModuleHeartbeatResponse registerHeartbeat(
      @PathVariable String moduleCode, @RequestBody RegisterModuleHeartbeatRequest request) {
  ...
  public RegisterModuleIncidentResponse registerIncident(
      @PathVariable String moduleCode, @RequestBody RegisterModuleIncidentRequest request) {
  ...
  public List<ModuleAvailabilityHistoryResponse> listAvailabilityHistory(
