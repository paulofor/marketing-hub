...
/**
 * Responsabilidade: disponibilizar a borda HTTP canônica da etapa Imagem do pipeline GeraAnuncio
 * v2.
 */
@RestController
...
public class GeraAnuncioImagemController {
  ...
  public GeraAnuncioImagemExecutionSummaryResponse startPorIdExterno(
  ...
  public List<GeraAnuncioImagemExecutionSummaryResponse> listStageExecutions(
  ...
  public ResponseEntity<Void> recebeRequest(
      ...
      @RequestBody GeraAnuncioImagemRecebeRequestRequest request) {
    service.recebeRequest(idExterno, jobId, request);
    return ResponseEntity.accepted().build();
  }

  /**
   * Recebe o callback final do AI Worker com a resposta da etapa e retorna a próxima etapa, quando
   * existir.
   */
  ...
  public ResponseEntity<String> recebeResponse(
      @PathVariable String idExterno,
      @PathVariable String jobId,
      @RequestBody GeraAnuncioImagemRespostaRequest request) {
    log.info(
  ...
  public ResponseEntity<Void> recebePrompt(
      @PathVariable String stageExecutionId, @RequestBody GeraAnuncioImagemPromptRequest request) {
  ...
  public ResponseEntity<Void> recebeResposta(
      @PathVariable String stageExecutionId,
      @RequestBody GeraAnuncioImagemRespostaRequest request) {
  ...
  public GeraAnuncioImagemDetailResponse detailStageExecution(
      @PathVariable String stageExecutionId) {
