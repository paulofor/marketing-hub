...
public class GeraAnuncioTextoController {
  ...
  public GeraAnuncioTextoExecutionSummaryResponse startPorIdExterno(
  ...
  public List<GeraAnuncioTextoExecutionSummaryResponse> listStageExecutions(
  ...
  public ResponseEntity<Void> recebeRequest(
      ...
      @RequestBody GeraAnuncioTextoRecebeRequestRequest request) {
  ...
  public ResponseEntity<String> recebeResponse(
      @PathVariable String idExterno,
      @PathVariable String jobId,
      @RequestBody GeraAnuncioTextoRespostaRequest request) {
    log.info(
  ...
  public ResponseEntity<Void> recebePrompt(
      @PathVariable String stageExecutionId, @RequestBody GeraAnuncioTextoPromptRequest request) {
  ...
  public ResponseEntity<Void> recebeResposta(
      @PathVariable String stageExecutionId, @RequestBody GeraAnuncioTextoRespostaRequest request) {
  ...
  public GeraAnuncioTextoDetailResponse detailStageExecution(
