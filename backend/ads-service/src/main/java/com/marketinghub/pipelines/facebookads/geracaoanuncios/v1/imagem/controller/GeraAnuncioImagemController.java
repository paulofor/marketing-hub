package com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.controller;

import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.GeraAnuncioImagemService;
import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.detailStageExecution.GeraAnuncioImagemDetailResponse;
import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.listStageExecutions.GeraAnuncioImagemExecutionSummaryResponse;
import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.pending.GeraAnuncioImagemPendingResponse;
import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.recebePrompt.GeraAnuncioImagemPromptRequest;
import com.marketinghub.pipelines.facebookads.geracaoanuncios.v1.imagem.service.recebeResposta.GeraAnuncioImagemRespostaRequest;
...
@RestController
@RequestMapping("/api/internal/facebookads/geracaoanuncios/v1/imagem/stage-executions")
