...
public class CommercialPlanMapper {
  ...
  public CommercialPlanDto toDto(
    ...
    return new CommercialPlanDto(
        ...
        plan.getProductsToValidate(),
        plan.getProductTypesToExplore(),
        plan.getApproachesToTest(),
        plan.getCustomerConversationsTarget(),
        plan.getActualCampaignCost(),
        plan.getActualAiCost(),
        plan.getActualTotalCost(),
        plan.getActualRevenue(),
        plan.getActualExperimentsCreated(),
        plan.getActualExperimentsPublished(),
        plan.getExecutionSyncedAt(),
        daysRemaining(plan),
        plan.getNextAction(),
  ...
  public CommercialPlanMilestoneDto toMilestoneDto(CommercialPlanMilestone milestone) {
    return new CommercialPlanMilestoneDto(
        ...
        milestone.getProductsToValidate(),
        milestone.getProductTypesToExplore(),
        milestone.getApproachesToTest(),
        milestone.getCustomerConversationsTarget(),
        milestone.getActualCampaignCost(),
        milestone.getActualAiCost(),
        milestone.getActualTotalCost(),
        milestone.getActualRevenue(),
        milestone.getActualExperimentsCreated(),
        milestone.getActualExperimentsPublished(),
        milestone.getExecutionSyncedAt(),
