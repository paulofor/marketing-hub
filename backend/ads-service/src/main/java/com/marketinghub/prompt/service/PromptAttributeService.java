...
public class PromptAttributeService {
        ...
        .map(
            attr -> {
              PromptAttributeDescription desc =
                  descriptionRepository.findByAttribute_IdAndActiveTrue(attr.getId()).orElse(null);
  ...
  public PromptAttributeDto create(String entityName, CreatePromptAttributeRequest req) {
        ...
        attributeRepository
            ...
            .orElseGet(
                () -> {
                  ...
                  PromptAttribute newAttr =
                      PromptAttribute.builder().entity(entity).name(req.getName()).build();
    ...
    PromptAttributeDescription desc =
        PromptAttributeDescription.builder()
            .attribute(attribute)
  ...
  public PromptAttributeDto update(
      String entityName, String attrName, UpdatePromptAttributeRequest req) {
    PromptAttribute attribute =
        attributeRepository
            .findByEntity_NameAndName(entityName, attrName)
            .orElseThrow(() -> new EntityNotFoundException("PromptAttribute not found"));
