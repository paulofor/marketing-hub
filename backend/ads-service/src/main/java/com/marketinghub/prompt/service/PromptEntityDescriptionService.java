...
public class PromptEntityDescriptionService {
  ...
  public PromptEntityDescriptionService(
      PromptEntityDescriptionRepository descriptionRepository,
  ...
  public PromptEntityDescriptionDto getLatest(Long entityId) {
    return descriptionRepository
        .findByEntity_IdAndActiveTrue(entityId)
        .map(
            desc -> {
  ...
  public PromptEntityDescriptionDto update(
      Long entityId, UpdatePromptEntityDescriptionRequest req) {
    PromptEntity entity =
        entityRepository
            .findById(entityId)
    ...
    PromptEntityDescription desc =
        PromptEntityDescription.builder()
            .entity(entity)
