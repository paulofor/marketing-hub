...
public class PromptTemplateValidationService {
  ...
  public PromptTemplateValidationService(
      PromptDomainService promptDomainService, PromptDomainContextFactory contextFactory) {
  ...
  public PromptTemplateValidationResponse validate(PromptTemplateValidationRequest request) {
    ...
    try {
      List<PromptDomainObjectType> objects =
          promptDomainService.getObjectTypes(request.getDomain());
    ...
    try {
      Template template =
          new Template(
              "prompt-template-validation", new StringReader(request.getTemplate()), configuration);
