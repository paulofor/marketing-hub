...
public interface AiPromptSchemaTemplateRepository
  ...
  Optional<AiPromptSchemaTemplate>
  ...
  List<AiPromptSchemaTemplate> findByPipelineCodeOrderByStageCodeAscVersionDesc(
      String pipelineCode);

  /** Lista templates de uma etapa ordenando por versão. */
  List<AiPromptSchemaTemplate> findByPipelineCodeAndStageCodeOrderByVersionDesc(
      String pipelineCode, String stageCode);
