...
public interface ExperimentAiPromptSchemaUsageRepository
    extends JpaRepository<ExperimentAiPromptSchemaUsage, Long> {
  /** Busca uso existente para manter registro idempotente por experimento, etapa e contexto. */
  Optional<ExperimentAiPromptSchemaUsage>
      findByExperimentIdAndTemplateKeyAndUsageContextAndStageCode(
          Long experimentId, String templateKey, String usageContext, String stageCode);
