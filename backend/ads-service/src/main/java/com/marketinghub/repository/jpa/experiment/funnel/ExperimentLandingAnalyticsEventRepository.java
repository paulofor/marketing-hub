...
public interface ExperimentLandingAnalyticsEventRepository
    extends JpaRepository<ExperimentLandingAnalyticsEvent, Long> {

  /** Busca evento normalizado já registrado para o mesmo identificador público de evento. */
  Optional<ExperimentLandingAnalyticsEvent> findFirstByExperimentIdAndEventId(
      Long experimentId, String eventId);
  ...
  @Query(
      """
            ...
            """)
  boolean existsPageViewInDeduplicationWindow(
  ...
  @Query(
      value =
          """
            ...
            """,
      nativeQuery = true)
  List<VisitorRecurrenceProjection> aggregateVisitorsByExperiment(
  ...
  /**
   * Apaga eventos normalizados de analytics de um experimento antes de remover os eventos brutos
   * vinculados.
   */
  @Modifying
