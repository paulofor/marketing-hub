...
public interface ExperimentLearningRequestRepository
    extends JpaRepository<ExperimentLearningRequest, Long> {
  ...
  boolean existsByExperimentIdAndStatusIn(
      Long experimentId, Collection<ExperimentLearningStatus> statuses);

  List<ExperimentLearningRequest> findByStatusInOrderByRequestedAtAsc(
