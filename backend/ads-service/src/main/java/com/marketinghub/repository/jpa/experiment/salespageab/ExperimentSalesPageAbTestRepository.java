...
public interface ExperimentSalesPageAbTestRepository
    extends JpaRepository<ExperimentSalesPageAbTest, Long> {
  ...
  Optional<ExperimentSalesPageAbTest> findTopByExperimentIdAndStatusInOrderByUpdatedAtDesc(
      Long experimentId, List<ExperimentSalesPageAbTestStatus> statuses);
}
