...
/** Repositório JPA responsável pela persistência de FacebookAdsAdSet. */
public interface FacebookAdsAdSetRepository extends JpaRepository<FacebookAdsAdSet, String> {
  ...
  /**
   * Remove conjuntos de anúncios vinculados às campanhas informadas antes de reprocessar a
   * publicação.
   */
  @Modifying
  ...
  @Query(
      """
            ...
            """)
  List<FacebookAdsAdSet> findDetailedByCampaignIds(
