...
public interface JourneyAssignmentRepository extends JpaRepository<JourneyAssignment, Long> {
  ...
  Page<JourneyAssignment> findByJourneyIdAndStatus(
  ...
  @Query(
      """
            ...
            """)
  Page<JourneyAssignment> findEligibleAssignments(
      @Param("statuses") Collection<JourneyAssignmentStatus> statuses,
