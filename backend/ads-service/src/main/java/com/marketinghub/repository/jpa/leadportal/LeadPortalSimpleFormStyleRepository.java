...
public interface LeadPortalSimpleFormStyleRepository
    extends JpaRepository<LeadPortalSimpleFormStyle, Long> {
  Optional<LeadPortalSimpleFormStyle> findBySlug(String slug);

  List<LeadPortalSimpleFormStyle> findByGenerationStatusOrderByUpdatedAtAscIdAsc(
      String generationStatus, Pageable pageable);
}
