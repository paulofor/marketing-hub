...
public interface ExperimentMetaAudienceRepository
    extends JpaRepository<ExperimentMetaAudience, Long> {
  /**
   * Busca vínculo existente para manter a operação idempotente por experimento, audiência e
   * parcela.
   */
