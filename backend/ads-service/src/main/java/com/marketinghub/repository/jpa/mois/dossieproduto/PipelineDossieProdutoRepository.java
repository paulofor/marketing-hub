 ...
 */
public interface PipelineDossieProdutoRepository
    extends JpaRepository<PipelineDossieProduto, Long> {
  ...
  /**
   * Lista auditorias filtradas por produto, etapa e lista de status, trazendo as mais recentes
   * primeiro.
   */
  ...
  /**
   * Busca o início mais recente do fluxo para separar o reprocessamento atual do histórico
   * anterior.
   */
  Optional<PipelineDossieProduto>
  ...
  List<PipelineDossieProduto> findByIdExternoAndVersaoPipelineOrderByDataHoraAscIdAsc(
      String idExterno, String versaoPipeline);
