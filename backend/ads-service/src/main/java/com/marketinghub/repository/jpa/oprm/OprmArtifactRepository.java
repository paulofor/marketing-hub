...
public interface OprmArtifactRepository extends JpaRepository<OprmArtifact, Long> {
  ...
  List<OprmArtifact> findByOccupationSeedRefAndArtifactStatusOrderByCreatedAtDesc(
      String occupationSeedRef, OprmArtifactStatus artifactStatus);

  List<OprmArtifact> findByOccupationSeedRefOrderByCreatedAtDesc(String occupationSeedRef);

  java.util.Optional<OprmArtifact> findFirstByOccupationSeedRefAndArtifactTypeOrderByCreatedAtDesc(
      String occupationSeedRef, String artifactType);
}
