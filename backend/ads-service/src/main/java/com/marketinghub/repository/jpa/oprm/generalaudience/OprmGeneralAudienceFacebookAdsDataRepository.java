...
public interface OprmGeneralAudienceFacebookAdsDataRepository
    extends JpaRepository<OprmGeneralAudienceFacebookAdsData, Long> {
  ...
  List<OprmGeneralAudienceFacebookAdsData> findAllByPainAngle_IdOrderByCreatedAtAsc(
      Long painAngleId);
}
