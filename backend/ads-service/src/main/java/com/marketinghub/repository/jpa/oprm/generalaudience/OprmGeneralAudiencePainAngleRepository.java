...
public interface OprmGeneralAudiencePainAngleRepository
    extends JpaRepository<OprmGeneralAudiencePainAngle, Long> {
  ...
  long countBySubnicheIdAndStatusIn(
      Long subnicheId, Collection<OprmGeneralAudiencePainAngleStatus> statuses);
}
