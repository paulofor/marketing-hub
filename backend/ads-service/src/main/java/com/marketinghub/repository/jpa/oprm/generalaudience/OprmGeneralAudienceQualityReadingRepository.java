...
public interface OprmGeneralAudienceQualityReadingRepository
    extends JpaRepository<OprmGeneralAudienceQualityReading, Long> {
  ...
  Optional<OprmGeneralAudienceQualityReading> findTopBySubnicheIdOrderByCapturedAtDesc(
      Long subnicheId);
}
