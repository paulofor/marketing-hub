...
public interface OprmNichoCnaeV2StageExecutionRepository
    extends JpaRepository<OprmNichoCnaeV2StageExecution, Long> {
  ...
  /**
   * Conta execuções já abertas para o candidato na etapa para gerar jobId estável de nova rodada
   * manual.
   */
  ...
  /**
   * Conta execuções por CNAE e estados informados para impedir dois jobs simultâneos no mesmo
   * mercado.
   */
  long countByCnaeCodeAndStatusIn(
      String cnaeCode, List<OprmNichoCnaeV2StageExecutionStatus> statuses);
