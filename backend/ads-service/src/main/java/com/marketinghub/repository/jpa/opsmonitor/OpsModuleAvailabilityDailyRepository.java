...
public interface OpsModuleAvailabilityDailyRepository
    extends JpaRepository<OpsModuleAvailabilityDaily, Long> {
  /** Lista histórico diário recente de um módulo. */
  List<OpsModuleAvailabilityDaily> findTop30ByModuleCodeOrderByAvailabilityDateDesc(
      String moduleCode);
}
