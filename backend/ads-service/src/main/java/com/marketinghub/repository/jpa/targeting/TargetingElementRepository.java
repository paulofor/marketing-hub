...
public interface TargetingElementRepository extends JpaRepository<TargetingElement, Long> {
  ...
  Optional<TargetingElement> findFirstByNicheIdAndTypeAndMetaId(
      Long nicheId, TargetingElementType type, String metaId);
  ...
  @Query(
      """
            ...
            """)
  List<TargetingElement> findByFilters(
  ...
  @Query(
      """
            ...
            """)
  List<TargetingElement> findApprovedForExperiment(
      @Param("nicheId") Long nicheId,
      @Param("type") TargetingElementType type,
  ...
  @Query(
      """
            ...
            where e.niche.id = :nicheId
              ...
              and (:hypothesisId is null or e.hypothesis is null or e.hypothesis.id = :hypothesisId)
            """)
  boolean existsApprovedForExperiment(
      @Param("nicheId") Long nicheId,
      @Param("type") TargetingElementType type,
      @Param("hypothesisId") UUID hypothesisId);
