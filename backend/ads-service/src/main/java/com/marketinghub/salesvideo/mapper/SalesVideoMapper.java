...
public final class SalesVideoMapper {
  ...
  public static SalesVideoProfileDto toDto(
      SalesVideoProfile profile, SalesVideoScript latestScript, SalesVideoJob lastJob) {
    if (profile == null) {
      return null;
    }
    ...
    dto.setLandingPageId(
        profile.getLandingPage() != null ? profile.getLandingPage().getId() : null);
  ...
  public static LandingVideoSlotHistoryDto toDto(LandingVideoSlotHistory history) {
    ...
    dto.setLandingPageId(
        history.getLandingPage() != null ? history.getLandingPage().getId() : null);
    ...
    dto.setPosterAssetId(
        history.getPosterAsset() != null ? history.getPosterAsset().getId() : null);
