...
public class SuccessProductService {
  ...
  public SuccessProductService(
      SuccessProductRepository repository, InstagramAccountRepository instagramAccountRepository) {
  ...
  public SuccessProduct create(CreateSuccessProductRequest request) {
    SuccessProduct product =
        SuccessProduct.builder()
            .description(request.getDescription())
            .novo(true)
            .platform(
                request.getPlatform() != null
                    ? request.getPlatform()
                    : SuccessProductPlatform.COFRE)
  ...
  public SuccessProduct update(Long id, UpdateSuccessProductRequest request) {
    ...
    if (request.getInstagramAccountId() != null) {
      InstagramAccount account =
          instagramAccountRepository.findById(request.getInstagramAccountId()).orElse(null);
