...
public class TargetingRequestMapper {
  ...
  private TargetingRequestDto toDto(
      TargetingRequest request, Integer etaSeconds, boolean includeCandidates) {
    if (request == null) return null;
    TargetingRequestDto.TargetingRequestDtoBuilder builder =
        TargetingRequestDto.builder()
            .id(request.getId())
