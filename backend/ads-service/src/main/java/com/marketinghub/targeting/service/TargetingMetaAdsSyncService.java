...
public class TargetingMetaAdsSyncService {
  ...
  /**
   * Atualiza o elemento com sucesso da Meta ou marca ausência definitiva de ID oficial para sair da
   * fila.
   */
  @Transactional
  public void updateMetaAdsData(Long id, UpdateTargetingMetaAdsDataRequest request) {
    ...
    } else if (Boolean.FALSE.equals(request.metaIdUnavailable())
        || StringUtils.hasText(request.metaId())) {
