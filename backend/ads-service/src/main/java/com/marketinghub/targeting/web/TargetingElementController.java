...
public class TargetingElementController {
  ...
  public TargetingElementController(
      TargetingElementService service, TargetingElementMapper mapper) {
  ...
  public TargetingElementDto update(
      @PathVariable Long id, @RequestBody UpdateTargetingElementRequest request) {
  ...
  public List<TargetingElementDto> list(
