...
public class TargetingInternalController {
  ...
  public TargetingInternalController(
      TargetingRequestService service,
  ...
  public List<TargetingRequestDto> listPending(
  ...
  public void saveCandidates(
      @PathVariable UUID requestId, @RequestBody TargetingCandidateIngestionRequest payload) {
  ...
  public List<TargetingMetaAdsPendingElementDto> listMetaAdsPending(
      @RequestParam(value = "limit", defaultValue = "50") Integer limit) {
    return metaAdsSyncService.listPending(limit != null ? limit : 50);
  }

  @PatchMapping("/elements/{id}/metaads")
  public void updateMetaAdsData(
      @PathVariable Long id, @RequestBody UpdateTargetingMetaAdsDataRequest request) {
