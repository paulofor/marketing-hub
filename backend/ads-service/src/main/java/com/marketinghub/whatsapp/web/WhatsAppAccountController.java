...
public class WhatsAppAccountController {
  ...
  public WhatsAppAccountController(
      WhatsAppAccountService accountService, WhatsAppAccountMapper accountMapper) {
  ...
  @PutMapping("/{id}")
  public WhatsAppAccountDto updateAccount(
      @PathVariable Long id, @RequestBody WhatsAppAccountRequest request) {
