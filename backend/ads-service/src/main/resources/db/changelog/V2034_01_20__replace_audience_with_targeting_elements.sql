...
--precondition-sql-check expectedResult:1 dbms:mysql SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'audience_targeting_seed';
DROP TABLE IF EXISTS audience_targeting_seed;
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:1 dbms:mysql SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'audience';
...
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 dbms:mysql SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'targeting_element';
...
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 dbms:mysql SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'targeting_element' AND index_name = 'idx_targeting_element_niche_type_status';
...
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 dbms:mysql SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'targeting_element' AND index_name = 'idx_targeting_element_hypothesis';
