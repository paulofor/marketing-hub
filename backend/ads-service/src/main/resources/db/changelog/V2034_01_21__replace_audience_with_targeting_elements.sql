...
--changeset repo:2034-01-21-drop-audience-targeting-seed dbms:mysql
...
--changeset repo:2034-01-21-drop-audience-table dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-drop-market-niche-audiences-to-generate dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-drop-market-niche-audience-model dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-interests-to-generate dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-job-titles-to-generate dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-behaviors-to-generate dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-interest-model dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-job-title-model dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-add-market-niche-behavior-model dbms:mysql
--preconditions onFail:MARK_RAN
...
--changeset repo:2034-01-21-create-targeting-element dbms:mysql
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'targeting_element';
CREATE TABLE targeting_element (
...
--changeset repo:2034-01-21-create-targeting-element-index-niche-type-status dbms:mysql
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'targeting_element' AND index_name = 'idx_targeting_element_niche_type_status';
CREATE INDEX idx_targeting_element_niche_type_status
    ON targeting_element (market_niche_id, type, status);

--changeset repo:2034-01-21-create-targeting-element-index-hypothesis dbms:mysql
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'targeting_element' AND index_name = 'idx_targeting_element_hypothesis';
