...
--changeset repo:2035-03-10-lead-portal-simple-form-style-column dbms:mysql
--preconditions onFail:MARK_RAN
...
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'lead_portal_flow' AND constraint_name = 'fk_lead_portal_flow_simple_form_style' AND constraint_type = 'FOREIGN KEY';
ALTER TABLE lead_portal_flow
