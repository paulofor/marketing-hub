...
SET experience_version = 'kit-whatsapp-pronto-pde-v2',
    ...
    draft_experience_json = CASE
      WHEN draft_experience_json IS NOT NULL AND JSON_VALID(draft_experience_json) = 1
      THEN JSON_SET(
    ...
    published_by = 'liquibase:rigel-commercial-experience-v2-slot-repair',
