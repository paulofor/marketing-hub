...
/** Utility methods to create and persist test fixtures respecting entity relationships. */
@Component
...
public class FixtureUtils {
  ...
  private final com.marketinghub.repository.jpa.creative.label.AngleRepository angleRepository;
  private final com.marketinghub.repository.jpa.hypothesis.HypothesisRepository
      hypothesisRepository;
  private final com.marketinghub.repository.jpa.experiment.MetricPresetRepository
      metricPresetRepository;
  ...
  public MarketNiche createAndSaveNiche() {
    MarketNiche niche = MarketNiche.builder().name("Niche").build();
  ...
  public com.marketinghub.hypothesis.Hypothesis createAndSaveHypothesis(MarketNiche niche) {
    ...
    com.marketinghub.hypothesis.Hypothesis h =
  ...
  public AdSet createAndSaveAdSet(Experiment exp) {
    AdSet adSet = AdSet.builder().experiment(exp).location("BR").durationDays(1).build();
