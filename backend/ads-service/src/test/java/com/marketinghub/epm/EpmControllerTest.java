...
class EpmControllerTest {
  ...
  @MockBean EpmService epmService;
  ...
  void shouldCreateFinancialPlanThroughApi() throws Exception {
    when(epmService.createFinancialPlan(any()))
        .thenReturn(
            new FinancialPlanResponse(
                1L,
                "Plano Junho",
                ...
                null,
                null));
    CreateFinancialPlanRequest request =
        new CreateFinancialPlanRequest(
            "Plano Junho",
            LocalDate.of(2026, 6, 1),
            LocalDate.of(2026, 6, 30),
            300_000L,
