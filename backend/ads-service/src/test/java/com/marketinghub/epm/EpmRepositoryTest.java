...
class EpmRepositoryTest {
  ...
  @Autowired FinancialPlanRepository financialPlanRepository;

  @Autowired FinancialPlanNicheRepository financialPlanNicheRepository;

  @Autowired FinancialPlanHypothesisRepository financialPlanHypothesisRepository;

  @Autowired ExperimentBudgetRepository experimentBudgetRepository;

  @Autowired ExperimentFinancialMetricRepository experimentFinancialMetricRepository;

  @Autowired ExperimentFinancialDecisionRepository experimentFinancialDecisionRepository;

  @Autowired ProductPriceScenarioRepository productPriceScenarioRepository;
  ...
  void shouldPersistFinancialHierarchyWithBudgetInCents() {
    ...
    FinancialPlanNiche niche =
        financialPlanNicheRepository.save(
    ...
    FinancialPlanHypothesis hypothesis =
        financialPlanHypothesisRepository.save(
    ...
    ExperimentBudget budget =
        experimentBudgetRepository.save(
    ...
    assertThat(saved.getFinancialPlanHypothesis().getFinancialPlanNiche().getPlannedBudgetCents())
        .isEqualTo(60_000L);
    assertThat(
            saved
                .getFinancialPlanHypothesis()
                .getFinancialPlanNiche()
                .getFinancialPlan()
                .getTotalBudgetCents())
        .isEqualTo(300_000L);
  }
  ...
  void shouldPersistFinancialMetricsDecisionAndPriceScenario() {
    ...
    ExperimentFinancialMetric metric =
        experimentFinancialMetricRepository.save(
    ...
    ExperimentFinancialDecision decision =
        experimentFinancialDecisionRepository.save(
    ...
    ProductPriceScenario scenario =
        productPriceScenarioRepository.save(
