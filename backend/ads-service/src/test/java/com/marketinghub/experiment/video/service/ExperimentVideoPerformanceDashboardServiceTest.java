...
class ExperimentVideoPerformanceDashboardServiceTest {
  ...
  void setUp() {
    service =
        new ExperimentVideoPerformanceDashboardService(
  ...
  void shouldSummarizeApprovedVideoWithMetaCreativeAndFunnelProgress() {
    ...
    ExperimentVideoAsset asset =
        ExperimentVideoAsset.builder()
            ...
            .build();
    given(videoAssetRepository.findByExperimentIdOrderByCreatedAtDesc(71L))
    ...
    ExperimentCampaignMetric metric =
        ExperimentCampaignMetric.builder()
            ...
            .build();
    given(campaignMetricRepository.findByCampaignIdIn(List.of("camp-71")))
        .willReturn(List.of(metric));
    given(funnelService.summarize(71L))
        .willReturn(
            List.of(
