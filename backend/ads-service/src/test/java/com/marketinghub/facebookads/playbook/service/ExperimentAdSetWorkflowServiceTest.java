...
class ExperimentAdSetWorkflowServiceTest {
  ...
  @Mock private ExperimentAdSetWorkflowRepository workflowRepository;
  @Mock private ExperimentAdSetJobRepository jobRepository;
  @Mock private ExperimentAdSetSpecRepository specRepository;
  @Mock private ExperimentAdSetJobApiLogRepository jobApiLogRepository;
  @Mock private ExperimentAdSetWorkflowJobCoordinator coordinator;
  ...
  void setUp() {
    service =
        new ExperimentAdSetWorkflowService(
