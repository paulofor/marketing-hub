...
class WireframeProvisionalHtmlAssemblerTest {
  ...
  private final WireframeProvisionalHtmlAssembler assembler =
      new WireframeProvisionalHtmlAssembler(new ObjectMapper());
  ...
  void assembleDelegatesRawJsonWithoutAssemblerNormalization() throws Exception {
    Map<String, Object> section =
        Map.of(
            ...
            "uiTags",
                "<!doctype html><html><body><section id='s1-hero-form'><h1 id='s1-h1'></h1></section></body></html>",
            "uiSizes",
                "{\"#s1-hero-form\":{\"padding\":\"20px 16px\"},\"#s1-wrap\":{\"gridTemplateColumns\":\"1fr\"}}");
    Map<String, Object> model =
        Map.of("landingPageWireframe", Map.of("sectionOrder", List.of(section)));
  ...
  void assemblePreservesPlainCssUiSizesIncludingImageDimensions() {
    ...
    assertTrue(
        html.contains(
            "#img-s1-mockup{width:100%;height:auto;aspect-ratio:4/5;object-fit:cover;border-radius:12px;}"));
    assertTrue(
        html.contains(
            "#img-s1-kit{width:100%;height:auto;aspect-ratio:1/1;object-fit:cover;border-radius:12px;}"));
  }
}
