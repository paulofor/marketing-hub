...
class GeraLandingCopyStageExecutionServiceTest {
  ...
  void startShouldRegisterInitialExecutionForCopyStage() {
    ...
    GeraLandingCopyStageExecutionService service =
        new GeraLandingCopyStageExecutionService(
  ...
  void markPromptReceivedShouldPersistPromptPayload() {
    ...
    when(executionRepository.findTopByIdJobOrderByExecutionRequestedAtDesc(
            "job-copy".getBytes(StandardCharsets.UTF_8)))
  ...
  /**
   * Deve concluir com sucesso, gravar métricas, persistir o artefato final de copy e enfileirar
   * prompts de imagem.
   */
  @Test
            ...
            argThat(
                nextExecution ->
                    nextExecution.getExperimentId().equals(88L)
                        ...
                        && nextExecution
                            .getPromptContent()
                            .equals("Gera Prompt Imagem iniciado automaticamente após o Gera Copy.")
  ...
  void markCompletedFromResponseShouldNotPersistCopyArtifactOnFailure() {
    ...
    service.markCompletedFromResponse(
        "job-copy", 88L, "landing-page-copy", null, null, null, null, null, null, "erro técnico");
