...
class BackendImageGenerationControllerTest {
  ...
  void startShouldDelegateToBackendImageGenerationService() {
    ...
    BackendImageGenerationController controller =
        new BackendImageGenerationController(executionService);
  ...
  void pendingShouldReturnStartedImageGenerationJobs() {
    ...
    BackendImageGenerationController controller =
        new BackendImageGenerationController(executionService);
    List<RecordImageGenerationPending> pending =
        List.of(
  ...
  void pendingShouldSerializeListItemsWithExperimentAndJobid() throws Exception {
    ...
    BackendImageGenerationController controller =
        new BackendImageGenerationController(executionService);
    when(executionService.listPending("landing-page-image-generation"))
        .thenReturn(
            List.of(
                new RecordImageGenerationPending(
                    33L,
  ...
  private RecordImageGenerationExperiment pendingExperiment(
      Long id, String name, String hypothesis) {
