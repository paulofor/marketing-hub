...
class BackendPublicLandingServiceTest {
  ...
  void approveEndPublishShouldPublishGeraLandingHtmlAndPersistStandaloneUrl() {
    ...
    experiment.setHtmlGeraLanding(
        "<html><head><title>LP</title></head><body><section id=\"hero\">Oferta</section></body></html>");
    ...
    assertEquals(
        "http://lead-portal/api/public/flows/exp-35-landing-geralanding", response.iframeUrl());
    assertEquals(
        "http://lead-portal/api/flows/exp-35-landing-geralanding/page", response.standaloneUrl());
    ...
    assertEquals(
        URI.create("http://lead-portal/api/flows/exp-35-landing-geralanding"),
        uriCaptor.getValue());
  ...
  void approveEndPublishShouldThrowConflictWhenLandingHtmlIsMissing() {
    ...
    ResponseStatusException exception =
        org.junit.jupiter.api.Assertions.assertThrows(
            ResponseStatusException.class, () -> service.approveEndPublish(88L));
