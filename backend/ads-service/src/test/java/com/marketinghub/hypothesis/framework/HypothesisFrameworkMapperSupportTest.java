...
class HypothesisFrameworkMapperSupportTest {
  ...
  void shouldStoreSnapshotAndSyncLegacyFields() {
    ...
    HypothesisFrameworkDto update =
        HypothesisFrameworkDto.builder()
            .pain(
                HypothesisFrameworkDto.Pain.builder()
                    .surface("Demanda sazonal cair")
                    .root("Sem planejamento de rematrícula")
                    .build())
            .offer(
                HypothesisFrameworkDto.Offer.builder()
    ...
    assertThat(stored.getOffer().getCorePromise())
        .isEqualTo("Transformar previsibilidade em 45 dias");
  }
}
