...
class SalesPagePatternsPagePatternExtractionServiceTest {
  @Mock private MoisSalesPageRepository salesPageRepository;

  @Mock private PipelineDossieProdutoRepository pipelineDossieProdutoRepository;

  @Mock private DossierProductContextGateway productContextGateway;

  @Mock private AiPromptSchemaTemplateRepository templateRepository;

  @Mock private JdbcTemplate jdbcTemplate;

  @InjectMocks private SalesPagePatternsPagePatternExtractionService service;
  ...
  void shouldPersistCleanFinalResponseFromResponsesApiEnvelope() {
    ...
    ArgumentCaptor<PipelineDossieProduto> pipelineCaptor =
        ArgumentCaptor.forClass(PipelineDossieProduto.class);
