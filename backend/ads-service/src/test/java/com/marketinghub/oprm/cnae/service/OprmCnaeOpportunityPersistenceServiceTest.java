...
class OprmCnaeOpportunityPersistenceServiceTest {
  ...
  @Mock private OprmCnaeOpportunityReadRepository opportunityReadRepository;

  @Mock private OprmCnaeOpportunityScoreRepository scoreRepository;

  @Mock private OprmCnaeProcessingCycleRepository cycleRepository;

  @Mock private OprmCnaeEnrichmentArtifactRepository artifactRepository;

  @Mock private OprmNicheCandidateRepository candidateRepository;

  private OprmCnaeOpportunityPersistenceService service;

  /**
   * Inicializa o serviço com dependências mockadas para isolar a consulta de candidatos
   * enriquecidos.
   */
  @BeforeEach
  void setUp() {
    service =
        new OprmCnaeOpportunityPersistenceService(
  ...
  void shouldListEnrichedCandidatesByHighestOpportunityScoreFirst() {
    ...
    verify(candidateRepository)
        .findAllByOrderByOpportunityScoreDescCreatedAtDesc(any(Pageable.class));
  }
  ...
  void shouldCreateEnrichedCandidateWithPendingRoutineResearchStatus() {
    ...
    service.saveEnrichment(
        new OprmCnaeEnrichmentRequestDto(
            "9602501",
            ...
            "fontes",
            List.of(
                new OprmNicheCandidateRequestDto(
                    "9602501",
  ...
  private OprmNicheCandidate candidate(
      Long id, String cnaeCode, String nicheName, String opportunityScore) {
