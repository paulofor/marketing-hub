...
class RoutineResearchNicheNameNormalizerTest {
  private final RoutineResearchNicheNameNormalizer normalizer =
  ...
  void shouldFallbackToCnaeDescriptionWhenNeutralNameIsWeak() {
    NormalizedNicheName result =
        normalizer.normalize("software para", "Manutenção de computadores");
  ...
  void shouldKeepNeutralNicheName() {
    NormalizedNicheName result =
        normalizer.normalize("Cabeleireiros e manicures", "Cabeleireiros, manicure e pedicure");
