...
class OprmMeiAudienceProfileRepositoryTest {
  ...
  /**
   * Valida que o contrato de público-alvo MEI/autônomo persiste sem campos de produto, oferta ou
   * campanha.
   */
  @Test
  void saveAndFindByResearchCycleKeepsAudienceContractTraceable() {
    ...
    profile.setRecurringTasksSummary(
    ...
    assertThat(repository.findFirstByResearchCycleIdOrderByIdDesc(1001L))
        ...
        .containsExactly("manicures MEI que atendem por agenda própria", "9602501", 92, 0);
