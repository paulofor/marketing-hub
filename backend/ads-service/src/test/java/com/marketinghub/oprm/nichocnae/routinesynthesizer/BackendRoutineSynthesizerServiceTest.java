...
class BackendRoutineSynthesizerServiceTest {
  ...
  void shouldAcceptLongMechanismSummaryBackedByLongtextColumn() {
    ...
    ArgumentCaptor<OprmNicheRoutineCard> captor =
        ArgumentCaptor.forClass(OprmNicheRoutineCard.class);
    verify(cardRepository).save(captor.capture());
    assertThat(captor.getValue().getMechanismOpportunitiesSummary())
        .isEqualTo(longMechanismSummary);
