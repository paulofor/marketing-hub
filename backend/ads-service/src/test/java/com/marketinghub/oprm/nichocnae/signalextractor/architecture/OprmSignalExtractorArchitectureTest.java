...
class OprmSignalExtractorArchitectureTest {
  ...
  private static final String SERVICE_PACKAGE =
      "com.marketinghub.oprm.nichocnae.signalextractor.service";
  private static final String REPOSITORY_PACKAGE = "com.marketinghub.repository.jpa.oprm.nichocnae";

  /**
   * Garante que o controller da etapa cinco fica no pacote web direto e expõe a fila pending
   * canônica.
   */
  @Test
  void controllerShouldFollowBackendStageContract() throws NoSuchMethodException {
    ...
    assertThat(controller.getPackageName())
        .as(
            "[ARQUITETURA] BackendSignalExtractorController deve ficar no pacote web direto da etapa")
  ...
  /**
   * Garante que o service canônico da etapa cinco é único na raiz service e anotado como serviço
   * Spring.
   */
  @Test
  void serviceShouldFollowBackendStageContract() {
    ...
    assertThat(service.getPackageName())
        .as(
            "[ARQUITETURA] BackendSignalExtractorService deve ficar no pacote service direto da etapa")
    ...
    List<Class<?>> operationDtos =
        List.of(
            com.marketinghub
                ...
                .CompleteSignalExtractorRequest
                .class,
            com.marketinghub
                .oprm
                .nichocnae
                ...
                .service
                .completeStageExecution
                .CompleteSignalExtractorResponse
                .class,
            com.marketinghub
                .oprm
                .nichocnae
  ...
  /**
   * Garante que a persistência da etapa cinco permanece centralizada em
  ...
  void repositoryShouldRemainInCanonicalJpaRepositoryPackage() {
    assertThat(OprmExtractedSignalRepository.class.getPackageName())
        .as(
            "[ARQUITETURA] OprmExtractedSignalRepository deve ficar em com.marketinghub.repository.jpa")
        .isEqualTo(REPOSITORY_PACKAGE);
    assertThat(JpaRepository.class.isAssignableFrom(OprmExtractedSignalRepository.class))
        .as(
            "[ARQUITETURA] OprmExtractedSignalRepository deve ser o repository JPA canônico da etapa")
        .isTrue();
  }
}
