...
/**
 * Valida que o backend da etapa commercial-evidence-gate atua somente como leitura e escrita para o
 * executor.
 */
...
class BackendCommercialEvidenceGateServiceTest {
  ...
  /**
   * Deve preservar retry técnico sem mudar tentativa cognitiva quando a falha da etapa 7 for
   * infraestrutura.
   */
  @Test
  ...
  private BackendCommercialEvidenceGateService service(boolean v2Enabled) {
    return new BackendCommercialEvidenceGateService(
