...
class BackendSourceSafetyFilterServiceTest {
    ...
    var response =
        service.complete(
            ...
            new SourceSafetyFilterCompletionRequest(
                ...
                2,
                1,
                "{\"allowedUrls\":[\"https://gov.br/exemplo\"]}",
  ...
  /**
   * Deve preservar retry técnico sem mudar tentativa cognitiva quando a falha da etapa 2 for
   * infraestrutura.
   */
  @Test
    ...
    var response =
        service.fail(
            ...
            new SourceSafetyFilterFailureRequest(
                OprmNichoCnaeV2FailureType.INFRASTRUCTURE, "TIMEOUT", "timeout lendo fila", "{}"));
  ...
  private BackendSourceSafetyFilterService service(boolean v2Enabled) {
    return new BackendSourceSafetyFilterService(
  ...
  private OprmNichoCnaeV2StageExecution execution(Long id) {
    ...
    execution.setInputPayload(
        "{\"candidateUrls\":[\"https://gov.br/exemplo\",\"https://adult.example/x\"]}");
