...
class OpenAiRequestInputExtractorTest {
  private final OpenAiRequestInputExtractor extractor =
      new OpenAiRequestInputExtractor(new ObjectMapper());

  /** Deve extrair input textual simples da Responses API. */
  @Test
  void extractShouldReturnTextualInput() {
    String rawRequest =
        "{\"model\":\"gpt-5.2\",\"input\":\"# Prompt operacional\",\"service_tier\":\"flex\"}";
