...
class BackendSourceSearcherV3ServiceTest {
  ...
  void setUp() {
    service =
        new BackendSourceSearcherV3Service(
            repository, cnaeRepository, pipelineNichoCnaeRepository, openAiPricingService);
  }

  /**
   * Marca o CNAE como concluído quando source-searcher encerra sem próxima etapa, removendo
   * pendência antiga.
   */
  @Test
  ...
  /**
   * Marca o CNAE como falha quando source-searcher é cancelado ou reporta erro, removendo pendência
   * antiga.
   */
  @Test
