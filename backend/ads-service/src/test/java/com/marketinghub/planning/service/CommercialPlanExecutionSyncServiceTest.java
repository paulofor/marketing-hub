...
class CommercialPlanExecutionSyncServiceTest {
  ...
  void syncFillsMonthlyAndMilestoneActualValues() {
    ...
    CommercialPlanExecutionSyncService service =
        new CommercialPlanExecutionSyncService(
            jdbcTemplate, new CurrencyConversionService(properties));
  ...
  /**
   * Responsabilidade: devolver respostas previsiveis para as consultas sequenciais do
   * sincronizador.
   */
