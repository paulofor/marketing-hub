...
class OprmConfirmedMarketNicheRepositoryTest {
  ...
  void shouldUpdateExistingConfirmedNiche() {
    ...
    OprmConfirmedMarketNicheRepository repository =
        new OprmConfirmedMarketNicheRepository(marketNicheRepository);
    ...
    OprmConfirmedMarketNiche updated =
        repository.updateConfirmedNiche(
            24L,
            "Promoção de vendas atualizada",
            "Nova pesquisa auditável",
            new BigDecimal("0.19"));
