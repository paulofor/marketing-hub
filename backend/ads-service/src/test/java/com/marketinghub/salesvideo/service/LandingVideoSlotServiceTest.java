...
class LandingVideoSlotServiceTest {
  ...
  @Mock private LandingVideoSlotRepository slotRepository;
  ...
  @Mock private LandingVideoSlotHistoryRepository historyRepository;

  @Mock private SalesVideoExperimentAssetApprovalChecker experimentAssetApprovalChecker;
  ...
  void shouldListSlotsForLanding() {
    ...
    LandingVideoSlot slot =
        LandingVideoSlot.builder()
            ...
            .lazyLoad(true)
            .build();
    given(slotRepository.findByLandingPageIdAndTenantId(landingId, "tenant-test"))
  ...
  void shouldBlockPublicationWhenExperimentVideoAssetIsNotApproved() {
    ...
    try {
      VideoModuleException exception =
          assertThrows(VideoModuleException.class, () -> service.create(landingId, request));
