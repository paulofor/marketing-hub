...
class TargetingElementRepositoryTest {
  ...
  @Autowired private TargetingElementRepository repository;
  ...
  void findMetaAdsPendingIncludesNeedsReviewInterestJobTitleAndBehavior() {
    ...
    TargetingElement jobTitle =
        pendingElement(niche, TargetingElementType.JOB_TITLE, "Fashion Designer");
    TargetingElement behavior =
        pendingElement(niche, TargetingElementType.BEHAVIOR, "Engaged shoppers");
  ...
  private TargetingElement pendingElement(
      MarketNiche niche, TargetingElementType type, String term) {
