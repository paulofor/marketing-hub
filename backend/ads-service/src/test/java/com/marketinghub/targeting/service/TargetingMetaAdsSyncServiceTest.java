...
class TargetingMetaAdsSyncServiceTest {
  @Mock private TargetingElementRepository repository;

  /**
   * Deve marcar elemento sem ID oficial da Meta e limpar dados parciais para impedir nova tentativa
   * automática.
   */
  @Test
  void updateMetaAdsDataMarksMetaIdUnavailableAndClearsPartialData() {
    ...
    service.updateMetaAdsData(
        7L, new UpdateTargetingMetaAdsDataRequest(null, null, null, null, true, "sem match"));
  ...
  void updateMetaAdsDataClearsUnavailableFlagWhenMetaIdIsSaved() {
    ...
    service.updateMetaAdsData(
        9L, new UpdateTargetingMetaAdsDataRequest("456", "Interesse", 100L, 200L, null, null));
