...
class TargetingResolutionJobServiceTest {
  ...
  @Mock private TargetingResolutionJobRepository repository;
  ...
  void summarizeByRequestIdsShouldReturnLatestFinishedAtAsLastCompletedAt() {
    TargetingResolutionJobService service =
        new TargetingResolutionJobService(repository, entityManager, transactionManager);
    ...
    Map<UUID, TargetingResolutionJobService.TargetingResolutionSummary> summaryMap =
        service.summarizeByRequestIds(List.of(requestId));
