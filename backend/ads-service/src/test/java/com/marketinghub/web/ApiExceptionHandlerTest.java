...
class ApiExceptionHandlerTest {
  ...
  /**
   * Verifica que uma ResponseStatusException preserva o status e a mensagem definidos pela regra de
   * negócio.
   */
  @Test
  ...
  void shouldReturnBadRequestWhenMultipartStreamEndsUnexpectedly() {
    ...
    MultipartException exception =
        new MultipartException(
            "Falha ao parsear request", new RuntimeException("Stream ended unexpectedly"));
  ...
  void shouldReturnRequestIdWhenUnexpectedExceptionBecomesInternalServerError() {
    ...
    var response =
        handler.handleUnexpectedException(new RuntimeException("Falha inesperada"), request);
