...
/** Responsabilidade: bloquear rotinas automáticas de Psique quando o backend determinar STOP. */
@Component
public class AutomaticExecutionControl {
  ...
  public boolean allowsAutomaticExecution() {
    try {
      ...
      log.error("Falha ao comprovar PLAY; Psique permanecerá parada. agentKey={}", AGENT_KEY, ex);
      return false;
    }
  }
