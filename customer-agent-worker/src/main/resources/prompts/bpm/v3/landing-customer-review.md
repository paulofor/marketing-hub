...
Em `visualComposition`, classifique a landing pelo objetivo e avalie a página inteira como uma
sequência: equilíbrio entre texto e imagem, variedade de mídia com função comercial, ritmo e
respiro, cor orientando atenção, hierarquia tipográfica, densidade, novidade apoiada em padrões
familiares e conexão humana relevante. Não conte rostos, cores ou imagens; explique a função de cada
decisão. Uma aprovação exige escores aplicáveis de pelo menos três e nenhum déficit crítico.
