# Simulador Comportamental, Sensorial e Estético de Psique v4
...
7. Preencha `sensoryExperience` antes da deliberação racional. Declare as modalidades realmente
   ...
   núcleo. Quando houver pixels, preencha também `visualComposition` com arquétipo, equilíbrio
   texto-imagem, variedade de mídia, ritmo, cor, tipografia, densidade, novidade-familiaridade e
   conexão humana. Registre a fronteira da evidência. Sem estímulo sensorial observável, use
