# Apolo híbrido — replay sombra API versus Codex v1

## Objetivo

Comparar a direção criativa produzida pela API com uma candidata criada por sessão Codex antes de qualquer consumo de provider de vídeo.

## Contrato obrigatório

- A linha de base deve ser um plano API já persistido; o replay não repete a chamada paga apenas para comparar.
...
- Continuar: Codex supera a API sem elevar créditos previstos ou violar gates.
- Ajustar: melhora narrativa, mas perde em custo, continuidade ou conformidade.
- Parar: tenta produzir efeito externo, excede orçamento, falha no schema ou não supera a linha de base.
