...
versão e a etapa concreta. Exemplo backend para o dossiê da Biblioteca de Páginas de Vendas: `com.marketinghub.moissaleslibraryworker.pipelines.dossieproduto.v1.qualificafontes`.
Exemplo módulo executor para o mesmo fluxo: `com.marketinghub.pipelines.dossie.v1.qualificafontes`.
