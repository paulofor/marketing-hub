...
versão e a etapa concreta. Exemplo backend para o dossiê da Biblioteca de Páginas de Vendas: `com.marketinghub.moissaleslibraryworker.pipelines.dossie.v1.qualificafontes`.
