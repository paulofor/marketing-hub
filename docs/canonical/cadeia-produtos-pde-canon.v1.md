# Cadeia canônica de criação e venda de Produtos Digitais Experienciais — v1
...
2. Seis macroprocessos: mantém um objetivo final e um gate claro por processo, reutilizando os
   processos especializados existentes.
3. Dez ou mais processos especializados: aumenta rastreabilidade, porém cria complexidade prematura.
...
-> 3. Construir e aprovar o PDE
-> 4. Preparar comunicação e jornada de venda
-> 5. Homologar e ativar
-> 6. Vender, entregar, aprender e decidir escala
```
...
**Objetivo final:** transformar a oportunidade aprovada em uma tese comercial única, simples,
mensurável e financeiramente limitada.

**Entrada mínima:** dossiê aprovado e evidências de oportunidade.
...
**Entrada mínima:** ativação autorizada, orçamento e critérios de decisão vigentes.
...
**Saída final:** ciclo comercial com vendas e entrega auditadas, aprendizado válido e decisão
`CONTINUAR`, `AJUSTAR`, `ESCALAR` ou `PARAR`.

**Gate de escala:** somente escalar quando vendas, entrega e satisfação forem sustentáveis. Cliques,
assets produzidos, tarefas concluídas ou impacto estimado não contam como venda.
...
[o cânone dos ciclos](ciclos-aprendizado-vendas-canon.v1.md). A cadeia v12 e seus históricos
não são reescritos.
