...
- Campos textuais gerados pelo modelo na etapa `niche-research-seed-builder` não devem ser truncados antes da persistência; quando houver risco de tamanho variável, o contrato físico do banco deve preservar o conteúdo integral em campo textual amplo.
