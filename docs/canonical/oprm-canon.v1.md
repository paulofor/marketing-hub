...
- Na v2 originada do levantamento MEI, o fluxo foca obrigatoriamente MEI/autônomo/dono-operador brasileiro: a etapa `candidate-generator` deve gerar volume suficiente de recortes operacionais para CNAEs amplos, preferencialmente 8 a 12 candidatos centrados na pessoa que executa pessoalmente o trabalho, cobrindo executor, trabalho, rotina, aquisição de clientes, atendimento, cobrança, linguagem e contexto. A etapa `candidate-tournament` deve selecionar finalistas pela clareza operacional do subnicho MEI/autônomo e sinais mínimos de pesquisa, sem exigir dor validada; ausência de dor forte não deve encerrar o job nessa fase.
