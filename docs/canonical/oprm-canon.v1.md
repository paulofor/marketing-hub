...
- Na v2, a etapa `candidate-generator` deve gerar volume suficiente de recortes operacionais para CNAEs amplos, preferencialmente 8 a 12 candidatos neutros, cobrindo executor, trabalho, rotina e contexto. A etapa `candidate-tournament` deve selecionar finalistas pela clareza operacional do subnicho e sinais mínimos de pesquisa, sem exigir dor validada; ausência de dor forte não deve encerrar o job nessa fase.
