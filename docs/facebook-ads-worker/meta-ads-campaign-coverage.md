...
| Identidade (Página/Instagram) | Resolve `pageId` usando o default da conta, a página associada ao experimento ou o valor legado; `instagram_user_id` segue o mesmo fallback conta/experimento. | `facebook_ads_ad_creative.page_id`, `instagram_user_id`. |
