...
| Prompt compacto | decisão recebe achados e baseline sem HTML integral nem auditoria bruta; materialização recebe o HTML atual | nenhum bloco global de produto e nenhuma hipótese de recompensa gerada pelo modelo |
