...
| Observabilidade            | Persistir request, response, modelo, tokens quando disponiveis, artefatos, verificacao tecnica e decisao | Falha de agente, hash, ffprobe ou render permanece terminal e explicita          | `agent-executions.json`, `technical-verification.json` e `manifest.json` |
