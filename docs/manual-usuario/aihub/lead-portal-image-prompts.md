...
| Campo | Descrição |
| --- | --- |
| **Modelo de imagem** | Código do modelo informado ao worker. Para novas execuções, o catálogo oferece `gpt-image-2.5-sunburst`; modelos anteriores permanecem somente no histórico. Se deixar em branco, usamos o padrão configurado globalmente. |
