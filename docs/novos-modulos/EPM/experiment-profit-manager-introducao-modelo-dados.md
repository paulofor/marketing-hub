...
Consolida as métricas financeiras e de performance do experimento.
...
Registra eventos financeiros brutos.

Esta tabela pode ser implementada na fase 2, quando houver integração automática com Meta Ads, checkout, Lead Portal e AI Worker.
...
Registra as decisões tomadas pelo usuário, pelo sistema ou por revisão de IA.
...
Valores sugeridos para `recommended_by`:
...
Armazena cenários de preço para cálculo de ponto de equilíbrio e lucro alvo.
...
erDiagram
    ...
    EXPERIMENT_FINANCIAL_METRIC {
        ...
        BIGINT payment_fee_cents
        BIGINT platform_fee_cents
        BIGINT ai_cost_cents
        BIGINT tax_estimate_cents
