...
| PDE Platform frontend / Clube MUSA | `191.252.102.54` | `pde-platform/docker-compose.deploy.yml` | `PDE_PLATFORM_FRONTEND_IMAGE` | sempre em deploy por imagem | `https://v5.clubemusa.com.br` responde e primeira dobra carrega | experiencia do lead fica indisponivel ou desatualizada |
