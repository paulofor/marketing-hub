...
- **Processo:**
  ...
  - O pacote é registrado em `flow_submission_image_package` com `planned_outputs = 6`, `free_images = 0`, prompt final e modelo padrão `gpt-image-2.5-sunburst` (pode ser sobrescrito apenas por modelo ativo homologado).
