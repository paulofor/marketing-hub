...
- Em estimativas de alcance (`/reachestimate`), bloqueie apenas quando a Meta retornar limites fora da faixa canônica; se os limites não vierem na resposta, registre aviso e siga como teste controlado, salvo erro explícito de segmentação ou outro bloqueio canônico.
