...
import IndependentBusinessProcessExecutionDetailPage from "./pages/businessProcess/IndependentBusinessProcessExecutionDetailPage";
          ...
          <div className="container-fluid py-4">
            ...
            <Routes>
              ...
              <Route
                ...
                element={<SystemImprovementsPage />}
              />
              ...
              />
              <Route
                path="/audio-video-studio/videos-analysis/:referenceId/results"
                element={<AudioVideoStudioVideoAnalysisResultPage />}
              />
              <Route
              ...
              />
              <Route
                path="/mois/sales-pages-library/:pageId/dossier"
                element={<MoisSalesPageDossierPage />}
              />
