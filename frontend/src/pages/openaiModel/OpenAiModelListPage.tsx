          ...
          <tbody>
            {models.map((model) => (
              <tr key={model.id}>
                ...
                <td>
                  <span
                    className={`badge ${model.acceptsImageInput ? "text-bg-success" : "text-bg-secondary"}`}
                  >
                    {model.acceptsImageInput ? "Sim" : "Não"}
                  </span>
                </td>
            ...
            {models.length === 0 ? (
              <tr>
                <td colSpan={10} className="text-center text-body-secondary">
