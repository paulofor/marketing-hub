...
function buildPrompt(detail: {
  ...
  const lines = [
    ...
    "2. Gere um seed que responda quem é o nicho pesquisado.",
    "3. Gere de 12 a 15 queries, cada uma em linha lógica própria no array queries.",
    "4. Cada query deve conter o nome do nicho ou algum objeto comercial específico do nicho.",
    "5. Não gere query genérica como 'como vender mais'.",
    "6. Cubra rotina, perguntas do profissional, perguntas do cliente final, dores comerciais e produtos/serviços.",
    "7. Todas as queries devem sair com status PENDING e createdBy AI.",
    "8. Use queryGoal somente entre ROUTINE_DISCOVERY, NICHE_OWNER_QUESTION_DISCOVERY, FINAL_CUSTOMER_QUESTION_DISCOVERY, SALES_PAIN_DISCOVERY, PRODUCT_SERVICE_DISCOVERY e OFFER_PATTERN_DISCOVERY.",
    "9. Não inclua metadado técnico, comentário operacional, debugInfo ou JSON serializado dentro de texto funcional.",
  ];
  return lines.join("\n");
}
