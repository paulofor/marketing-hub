...
/** Responsabilidade: bloquear rotinas automáticas de Hermes quando o backend determinar STOP. */
@Component
public class AutomaticExecutionControl {
  ...
  private static final String AGENT_KEY = "growth-operator";
  private final RestClient backend;

  /** Configura a leitura do estado usando a mesma URL operacional de Hermes. */
  public AutomaticExecutionControl(WorkerProperties properties) {
  ...
  public boolean allowsAutomaticExecution() {
    try {
      ...
      log.error("Falha ao comprovar PLAY; Hermes permanecerá parado. agentKey={}", AGENT_KEY, ex);
      return false;
    }
  }
