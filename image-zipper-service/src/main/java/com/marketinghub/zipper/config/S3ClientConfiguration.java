package com.marketinghub.zipper.config;
...
public class S3ClientConfiguration {
    ...
    void validateProperties() {
        if (isBlank(storageProperties.getBucket())
            ...
            throw new IllegalStateException("Configurações de armazenamento inválidas para o serviço de zip das imagens");
        }
    }
    ...
    public S3Client s3Client() {
        ...
        log.info("Inicializando cliente S3 para ZIP (bucket: {})", storageProperties.getBucket());
