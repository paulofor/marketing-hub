...
run tests npm --prefix frontend test -- --run src/components/ProductNextProcessSummary.test.tsx src/components/ProductValueChainCycleSummary.test.tsx src/components/ProductValueChainPosition.test.tsx src/components/ProductValueChainPositionNavigation.test.tsx src/pages/product/ProductProcessAutomationPanel.test.tsx src/pages/HomePage.test.tsx src/pages/product/ProductListPage.test.tsx src/pages/product/ProductProcessActivityExecutionsPage.test.tsx src/pages/product/ProductValueChainHistoryPage.test.tsx src/pages/learningCycle/LearningCyclesPage.test.tsx
