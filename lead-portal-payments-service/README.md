...
- O mesmo proxy publica o Clube MUSA em `https://clubemusa.com.br` e nos subdomínios versionados. Cada versão produtiva ativa deve apontar para o container próprio da PDE Platform: `v5.clubemusa.com.br` para `pde-platform-frontend-v5`, `v6.clubemusa.com.br` para `pde-platform-frontend-v6` e `v7.clubemusa.com.br` para `pde-platform-frontend-v7`. O certificado de `clubemusa.com.br` precisa conter esses subdomínios como SANs antes de recriar o proxy.
