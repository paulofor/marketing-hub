...
- O mesmo proxy publica o Clube MUSA em `https://clubemusa.com.br` e nos subdomínios versionados `https://v5.clubemusa.com.br` até `https://v10.clubemusa.com.br`, roteando todos para o container `pde-platform-frontend`. O certificado de `clubemusa.com.br` precisa conter esses subdomínios como SANs antes de recriar o proxy.
