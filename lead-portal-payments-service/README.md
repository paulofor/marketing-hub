...
- O mesmo proxy publica o Clube MUSA em `https://clubemusa.com.br` e nos subdomínios versionados. Cada versão produtiva ativa deve apontar para a porta pública local do container próprio da PDE Platform: `v5.clubemusa.com.br` para `5176`, `v6.clubemusa.com.br` para `5177` e `v7.clubemusa.com.br` para `5178`. Isso evita 502 por falha de resolução DNS entre projetos Docker distintos. O certificado de `clubemusa.com.br` precisa conter esses subdomínios como SANs antes de recriar o proxy.
...
CERTBOT_EXTRA_DOMAINS="v5.clubemusa.com.br v6.clubemusa.com.br v7.clubemusa.com.br v8.clubemusa.com.br v9.clubemusa.com.br v10.clubemusa.com.br" \
