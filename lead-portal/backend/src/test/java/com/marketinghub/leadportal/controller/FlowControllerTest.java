...
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.delete;
                .andExpect(MockMvcResultMatchers.jsonPath("$.detail").value(containsString("missing-flow")));
...
@TestPropertySource(properties = "lead-portal.flow-storage.location=target/test-flows.json")
