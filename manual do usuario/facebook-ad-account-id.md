# Como obter o Facebook Ad Account ID
...
4. Você também pode visualizar o **Ad Account ID** no canto superior direito da tela do Gerenciador de Anúncios, ao lado do nome da conta.
5. Anote esse número; ele será utilizado na configuração da propriedade `facebook.ad-account-id` na sua aplicação.

> Dica: mantenha esse identificador em local seguro e evite compartilhá-lo publicamente.
