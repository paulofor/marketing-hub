...
> Para confirmar atualização, rode: `head -n 25 /opt/marketinghub/containers/bin/issue-mcp-letsencrypt-cert.sh | grep SCRIPT_VERSION`.
...
- preflight automático da challenge HTTP (evita tentar emissão quando o domínio ainda responde 404/serviço incorreto).
