...
Submódulo separado do MOIS para automatização da coleta de produtos quentes na Clickbank, com aplicação, container e imagem próprios.

## Objetivo

- Isolar o fluxo de automação web da Clickbank em serviço independente.
...
> O build gera `target/mois-clickbank-collector.jar` como JAR executável (fat jar Spring Boot).
...
- Local: `mois-clickbank-collector/.env`
- Host de deploy: `/opt/marketinghub/mois-clickbank-collector/.env`
...
1. Build da imagem Docker do módulo `mois-clickbank-collector`.
