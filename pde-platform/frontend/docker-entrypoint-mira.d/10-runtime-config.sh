...
EXPERIENCE_VERSION="${PDE_EXPERIENCE_VERSION:-mira-private-v2}"
FRONTEND_VERSION="${PDE_FRONTEND_VERSION:-mira-private-v2}"
...
FRONTEND_IMAGE_VERSION_ID="${PDE_FRONTEND_VERSION_ID:-mira-private-v2}"
