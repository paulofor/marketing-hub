...
const musaV7PublicDiagnosticQuestions: PublicDiagnosticQuestion[] = [
  {
    ...
    imageUrl: '/assets/musa-diagnostic-slide-1.png',
    visualTitle: 'A v7 começa pelo idioma silencioso da roupa.',
  ...
  },
  {
    ...
    options: ['Elegância discreta', 'Segurança calma', 'Cuidado percebido', 'Imagem mais marcante'],
    imageUrl: '/assets/musa-diagnostic-slide-3.png',
    visualTitle: 'Cada dia da v7 trabalha um sinal de presença.',
    visualText: 'Mensagem, peça-sinal, estrutura, primeira impressão, cor, assinatura pessoal e fórmula MUSA viram uma sequência prática.',
    journeyEventType: 'MECHANISM_VIEWED',
  },
  {
    key: 'startingResource',
    ...
    imageUrl: '/assets/musa-diagnostic-slide-4.png',
    visualTitle: 'A promessa da v7 é ciência traduzida em microação.',
  ...
  missions: [
    {
      ...
      principle: 'A vestimenta participa da percepção de pessoa: antes de explicar quem você é, sua imagem já envia sinais.',
      action: 'Vista uma combinação real e escreva a mensagem que ela parece transmitir hoje. Depois escolha um ajuste pequeno para aproximar essa mensagem da mulher que você quer comunicar.',
      evidence: 'Frase preenchida: hoje minha imagem parece dizer...',
      visualCue: 'Observe roupa, cabelo, pele e detalhe final como um conjunto de sinais, não como peças soltas.',
    },
    {
      id: 'dia-2-assinatura',
      day: 2,
...
export function resolveMusaFallbackProduct(experienceVersion = '') {
  return experienceVersion === MUSA_V7_EXPERIENCE_VERSION ? musaV7FallbackProduct : fallbackProduct;
}
