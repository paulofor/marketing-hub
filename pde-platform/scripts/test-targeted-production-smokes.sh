...
grep -Fqx $'consistency\thttps://v8.clubemusa.com.br\tmusa-pde-entry-v12-primeiro-ajuste-aplicavel\tVocê já escolheu a roupa. Falta saber qual ajuste fazer primeiro.' "${invocation_log}"
