...
# Monta o anúncio vertical de Capella apenas com os criativos reais aprovados do experimento #88.
...
output_path="${1:-/tmp/capella-successor-video-v1.mp4}"
temp_dir="$(mktemp -d)"
