...
- a receita deve ser suficiente para preencher um projeto do Estúdio de Áudio e Vídeo;
- cada cena proposta deve conter localização, ação visível, direção de câmera e função comercial;
- preserve continuidade por bíblia de personagem, ambiente, objetos, luz, lentes e transições;
- recomende apresentador/avatar/lip-sync somente quando isso for causal para o formato;
- recomende áudio original ou devidamente licenciado; nunca reutilize música, letra, voz, marca ou gravação da referência;
